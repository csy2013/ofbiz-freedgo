...
public class StoreData {
    /**
     * to : store
     * params : {"orgCode":74597,"imgOrder":1,"storeId":"10055645"}
     * words : 民生超市·百姓永辉
     * imgUrl : https://img30.360buyimg.com/vendersettle/jfs/t1963/102/1922378949/3615/5fe01608/56e626a2N3056b2fd.png
     * title : 4.8
     * userAction : {"orgCode":74597,"storeId":"10055645","imgOrder":1,"recommendType":2}
     * name : 永辉超市-滨江新城店
     * tags : [{"name":"白条","iconText":"白条","type":8,"belongIndustry":3,"words":"该商家支持使用京东白条","colorCode":"19BAFF"}]
     * serviceTimes : [{"startTime":"09:00","endTime":"19:00"}]
     * deliveryFirst : 可预订
     * storeType : 综合超市
     * inSale : 936件商品
     * monthSale : 月售3960单
    ...
    public StoreData(FloorCellData floorCellData, String floorCellType) {
    ...
    public static StoreData objectFromData(String str) {
        ...
        return new Gson().fromJson(str, StoreData.class);
    }
    
    public static StoreData objectFromData(String str, String key) {
        
        try {
            JSONObject jsonObject = new JSONObject(str);
            
            return new Gson().fromJson(jsonObject.getString(str), StoreData.class);
    ...
    public static List<StoreData> arrayDataFromData(String str) {
