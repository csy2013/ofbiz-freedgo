            ...
            if (headerValues != null) {
                for (String headerValue: headerValues) {
                    if ("equals".equals(operator)) {
                        ...
                        passedCondition = !headerValue.equals(value);
                        ...
                        passedCondition = !headerValue.matches(value);
            ...
            if (fieldValues != null) {
                for (String fieldValue: fieldValues) {
                    if ("equals".equals(operator)) {
                        ...
                        passedCondition = !fieldValue.equals(value);
                    } else if ("matches".equals(operator)) {
                        ...
                        passedCondition = !fieldValue.matches(value);
                    } else if ("not-empty".equals(operator)) {
                        passedCondition = true;
                        break;
                    }
