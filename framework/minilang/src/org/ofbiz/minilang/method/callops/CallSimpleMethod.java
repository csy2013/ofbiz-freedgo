...
public final class CallSimpleMethod extends MethodOperation {
    ...
    public boolean exec(MethodContext methodContext) throws MiniLangException {
        ...
        if (methodContext.getMethodType() == MethodContext.EVENT) {
            ...
            String responseCode = localContext.getEnv(this.simpleMethod.getEventResponseCodeName());
            ...
            String responseMessage = localContext.getEnv(this.simpleMethod.getServiceResponseMessageName());
