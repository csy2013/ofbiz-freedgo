 ...
 * under the License.
 */
package org.ofbiz.sso.cas.ssl.client;
...
public final class HttpsURLConnectionFactory implements HttpURLConnectionFactory {
    ...
    public HttpURLConnection buildHttpURLConnection(final URLConnection url) throws Exception {
     ...
     */
    private HttpURLConnection configureHttpsConnectionIfNeeded(final URLConnection conn) throws Exception {
...
//            final SSLSocketFactory socketFactory = this.createSSLSocketFactory();
            final SSLSocketFactory socketFactory = HttpsURLConnection.getDefaultSSLSocketFactory();
    ...
    public void ignorSsl() throws Exception {
