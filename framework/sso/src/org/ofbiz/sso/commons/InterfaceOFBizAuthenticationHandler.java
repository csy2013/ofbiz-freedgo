...
public interface InterfaceOFBizAuthenticationHandler {
     ...
     * @param response HttpServletResponsee
     ...
     */
    Object getSecurityGroup(Element rootElement, GenericValue result);
     ...
     */
    Object getPartyId(Element rootElement, GenericValue result);
...
*/
     ...
     * @throws Exception
     */
    GenericValue getBaseSearchResult(String username, String password, Element rootElement, boolean bindRequired, HttpServletRequest request) throws GenericEntityException, IllegalAccessException, InstantiationException, ClassNotFoundException;
     ...
     * @return true if the user has logged out from ldap; otherwise, false.
     */
    boolean hasBaseLoggedOut(HttpServletRequest request, HttpServletResponse response, Element rootElement);
