...
public interface GenericHelper {
    ...
    <T> Future<T> submitWork(Callable<T> callable) throws GenericEntityException;
    ...
    long findCountByCondition(ModelEntity modelEntity, EntityCondition whereEntityCondition,
     ...
     *@return int representing number of rows effected by this operation
     */
    int removeByCondition(ModelEntity modelEntity, EntityCondition condition) throws GenericEntityException;
     ...
     *@throws GenericEntityException
     */
    int storeByCondition(ModelEntity modelEntity, Map<String, ? extends Object> fieldsToSet, EntityCondition condition) throws GenericEntityException;
