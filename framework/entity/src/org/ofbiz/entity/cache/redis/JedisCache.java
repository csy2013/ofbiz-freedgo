...
public class JedisCache {
    ...
    public static final String module = JedisCache.class.getName();

    protected JedisEntityCache entityCache;
    protected JedisEntityListCache entityListCache;
    protected JedisEntityObjectCache entityObjectCache;

    protected String delegatorName;

    public JedisCache(String delegatorName) {
        this.delegatorName = delegatorName;
        entityCache = new JedisEntityCache(delegatorName);
        entityObjectCache = new JedisEntityObjectCache(delegatorName);
        entityListCache = new JedisEntityListCache(delegatorName);
    }
    ...
    public <T> T get(String entityName, EntityCondition condition, String name) {
        return UtilGenerics.cast(entityObjectCache.get(entityName, condition, name));
    }
    ...
    public <T> T put(String entityName, EntityCondition condition, String name, T value) {
        return UtilGenerics.cast(entityObjectCache.put(entityName, condition, name, value));
    }
    ...
    public <T> T remove(String entityName, EntityCondition condition, String name) {
        return UtilGenerics.cast(entityObjectCache.remove(entityName, condition, name));
    }
