 ...
 *
 */
public class JedisXmlSerializer {
    public static final String module = JedisXmlSerializer.class.getName();
    ...
    public static String serialize(Object object) throws SerializeException, IOException {
