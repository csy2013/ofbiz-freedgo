...
public class SQLProcessor {
     ...
     * @throws GenericEntityException
     */
    public void prepareStatement(String sql, boolean specifyTypeAndConcur, int resultSetType, int resultSetConcurrency, int fetchSize, int maxRows) throws GenericEntityException {
        if (Debug.verboseOn())
//            Debug.logVerbose("[SQLProcessor.prepareStatement] sql=" + sql, module);
              Debug.logError("[SQLProcessor.prepareStatement] sql=" + sql, module);
