package org.ofbiz.coloradmin.widget.form;
 ...
 */
public class ColoradminMacroFormRenderer extends MacroFormRenderer {

    public ColoradminMacroFormRenderer(String macroLibraryPath, HttpServletRequest request, HttpServletResponse response) throws TemplateException, IOException {
        super(macroLibraryPath, request, response);
    }

    public ColoradminMacroFormRenderer(String macroLibraryPath, Appendable writer, HttpServletRequest request, HttpServletResponse response) throws TemplateException, IOException {
