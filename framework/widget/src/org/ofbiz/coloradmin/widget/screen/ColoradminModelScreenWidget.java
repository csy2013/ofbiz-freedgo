...
import org.ofbiz.coloradmin.widget.html.ColoradminHtmlFormRenderer;
import org.ofbiz.coloradmin.widget.html.ColoradminHtmlMenuRenderer;
...
public abstract class ColoradminModelScreenWidget extends ModelScreenWidget {

    public static final String module = ColoradminModelScreenWidget.class.getName();
    ...
    public static final String extend = "coloradmin";
//    public static final String contarea = "contentarea";

    public ColoradminModelScreenWidget(ColoradminModelScreen modelScreen, Element widgetElement) {
    ...
    public static class Container extends ModelScreenWidget.Container {
        ...
        public Container(ColoradminModelScreen modelScreen, Element containerElement) {
            super(modelScreen, containerElement);
            // read sub-widgets
            List<? extends Element> subElementList = UtilXml.childElementList(containerElement);
            this.subWidgets = ColoradminModelScreenWidget.readSubWidgets(this.modelScreen, subElementList, "coloradmin");
        }
        ...
        public String getStyle(Map<String, Object> context) {
            ...
            if (style.equals("contentarea")) {
                String contentStyle = UtilProperties.getPropertyValue("coloradmin.properties", "admin.content");
                style = contentStyle;
            }else if(id.equals("left-column")){
                style = UtilProperties.getPropertyValue("coloradmin.properties","admin.default.container.style");
//                style = style + " am-fr";
            }else if(id.equals("centerdiv")){
                style = UtilProperties.getPropertyValue("coloradmin.properties","admin.default.container.style");
//                style = style + " am-fl";
            }else if(style.equals("lefthalf")){
                style = UtilProperties.getPropertyValue("coloradmin.properties", "admin.default.container.half.style");
//                style = style + " am-fl";
...
//                screenStringRenderer = new BootsMacroScreenRenderer(UtilProperties.getPropertyValue("widget.properties", getName() + ".name"), UtilProperties.getPropertyValue("widget", getName() + ".screenrenderer"));
    ...
    public static class Menu extends ModelScreenWidget.Menu {
        ...
        public Menu(ColoradminModelScreen modelScreen, Element menuElement) {
        ...
        public void renderWidgetString(Appendable writer, Map<String, Object> context, ScreenStringRenderer screenStringRenderer) throws IOException {
            ...
            if (menuStringRenderer == null) {
                ...
                if (request != null && response != null) {
                    menuStringRenderer = new ColoradminHtmlMenuRenderer(request, response);
                }
            }
    ...
    public static class DecoratorSection extends ModelScreenWidget.DecoratorSection {
        ...
        public DecoratorSection(ColoradminModelScreen modelScreen, Element decoratorSectionElement) {
    ...
    public static class ColumnContainer extends ModelScreenWidget.ColumnContainer {
        public ColumnContainer(ColoradminModelScreen modelScreen, Element containerElement) {
            super(modelScreen, containerElement);
    ...
    public static class Column extends ModelScreenWidget.Column {
        public Column(ColoradminModelScreen modelScreen, Element containerElement) {
            super(modelScreen, containerElement);
        }
        @Override
        public void renderWidgetString(Appendable writer, Map<String, Object> context, ScreenStringRenderer screenStringRenderer) throws GeneralException, IOException {
    ...
    public static class Screenlet extends ModelScreenWidget.Screenlet {
        ...
        public Screenlet(ColoradminModelScreen modelScreen, Element screenletElement) {
    ...
    public static class Section extends ModelScreenWidget.Section {
        ...
        public Section(ColoradminModelScreen modelScreen, Element sectionElement) {
    ...
    public static class DecoratorScreen extends ModelScreenWidget.DecoratorScreen {
        ...
        public DecoratorScreen(ColoradminModelScreen modelScreen, Element decoratorScreenElement) {
            ...
            for (Element decoratorSectionElement : decoratorSectionElementList) {
                DecoratorSection decoratorSection = new ColoradminModelScreenWidget.DecoratorSection(modelScreen, decoratorSectionElement);
        ...
        public void renderWidgetString(Appendable writer, Map<String, Object> context, ScreenStringRenderer screenStringRenderer) throws GeneralException, IOException {
            ...
            ColoradminModelScreenWidget.SectionsRenderer sections = new ColoradminModelScreenWidget.SectionsRenderer(this.sectionMap, standAloneStack, writer, screenStringRenderer);
            ...
            ScreenFactory.renderReferencedScreen(name, location, this, writer, context, screenStringRenderer, "coloradmin");
    ...
    public static class IncludeScreen extends ModelScreenWidget.IncludeScreen {
        ...
        public IncludeScreen(ColoradminModelScreen modelScreen, Element includeScreenElement) {
    ...
    public static class HorizontalSeparator extends ModelScreenWidget.HorizontalSeparator {
        ...
        public HorizontalSeparator(ColoradminModelScreen modelScreen, Element separatorElement) {
    ...
    public static class DecoratorSectionInclude extends ModelScreenWidget.DecoratorSectionInclude {
        ...
        public DecoratorSectionInclude(ColoradminModelScreen modelScreen, Element decoratorSectionElement) {
            super(modelScreen, decoratorSectionElement);
        }
        ...
        public void renderWidgetString(Appendable writer, Map<String, Object> context, ScreenStringRenderer screenStringRenderer) throws GeneralException, IOException {
            ...
            if (preRenderedContent != null && preRenderedContent.containsKey(this.name)) {
                ...
                ColoradminModelScreenWidget.SectionsRenderer sections = (ColoradminModelScreenWidget.SectionsRenderer) context.get("sections");
    ...
    public static class Label extends ModelScreenWidget.Label {
        ...
        public Label(ColoradminModelScreen modelScreen, Element labelElement) {
    ...
    public static class Form extends ModelScreenWidget.Form {
        ...
        public Form(ColoradminModelScreen modelScreen, Element formElement) {
        ...
        public void renderWidgetString(Appendable writer, Map<String, Object> context, ScreenStringRenderer screenStringRenderer) {
            ...
            if (formStringRenderer == null) {
                ...
                HttpServletResponse response = (HttpServletResponse) context.get("response");
                if (request != null && response != null) {
                    formStringRenderer = new ColoradminHtmlFormRenderer(request, response);
                }
            }
            // still null, throw an error
            if (formStringRenderer == null) {
    ...
    public static class Tree extends ModelScreenWidget.Tree {
        ...
        public Tree(ColoradminModelScreen modelScreen, Element treeElement) {
    ...
    public static class PlatformSpecific extends ModelScreenWidget.PlatformSpecific {
        ...
        public PlatformSpecific(ColoradminModelScreen modelScreen, Element platformSpecificElement) {
                ...
                if (childElements != null) {
                    for (Element childElement : childElements) {
                        if ("html".equals(childElement.getNodeName())) {
                            subWidgets.put("html", new ColoradminHtmlWidget(modelScreen, childElement));
                        } else if ("xsl-fo".equals(childElement.getNodeName())) {
                            subWidgets.put("xsl-fo", new ColoradminHtmlWidget(modelScreen, childElement));
                        } else if ("xml".equals(childElement.getNodeName())) {
                            subWidgets.put("xml", new ColoradminHtmlWidget(modelScreen, childElement));
                        } else {
    ...
    public static class Content extends ModelScreenWidget.Content {
        ...
        public Content(ColoradminModelScreen modelScreen, Element subContentElement) {
    ...
    public static class SubContent extends ModelScreenWidget.SubContent {
        ...
        public SubContent(ColoradminModelScreen modelScreen, Element subContentElement) {
            super(modelScreen, subContentElement);
        }
    }
    ...
    public static class Link extends ModelScreenWidget.Link {
        ...
        public Link(ColoradminModelScreen modelScreen, Element linkElement) {
    ...
    public static class Image extends ModelScreenWidget.Image {
        ...
        public Image(ColoradminModelScreen modelScreen, Element imageElement) {
    ...
    public static class PortalPage extends ModelScreenWidget.PortalPage {
        ...
        public PortalPage(ColoradminModelScreen modelScreen, Element portalPageElement) {
    ...
    public static class ModalPage extends ModelScreenWidget.ModalPage{
        ...
        public ModalPage(ColoradminModelScreen modelScreen, Element element) {
