 ...
 */
public class ColoradminModelScreen extends ModelScreen {

    // ===== CONSTRUCTORS =====
    /** Default Constructor */
    protected ColoradminModelScreen() {}

    /** XML Constructor */
    public ColoradminModelScreen(Element screenElement, Map<String, ModelScreen> modelScreenMap, String sourceLocation) {
        ...
        this.section = new ColoradminModelScreenWidget.Section(this, sectionElement);
