...
public class ColoradminMacroScreenRenderer extends MacroScreenRenderer {

    public static final String module = ColoradminMacroScreenRenderer.class.getName();

    public ColoradminMacroScreenRenderer(String name, String macroLibraryPath) throws TemplateException, IOException {
