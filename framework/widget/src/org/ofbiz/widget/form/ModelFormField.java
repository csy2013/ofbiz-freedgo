...
public class ModelFormField {
    ...
    public ModelFormField(Element fieldElement, ModelForm modelForm) {
        ...
        for (Element subElement : subElements) {
            ...
            else if ("startDate-find".equals(subElementName)) this.fieldInfo = new StartDateFindField(subElement, this);
            else if ("endDate-find".equals(subElementName)) this.fieldInfo = new EndDateFindField(subElement, this);
            ...
            else if ("confirm-modal".equals(subElementName))this.fieldInfo = new ConfirmModalField(subElement,this);
            else if ("modal-page".equals(subElementName))this.fieldInfo = new ModalPage(subElement,this);
    ...
    public boolean induceFieldInfo(String defaultFieldType) {
        ...
        return this.induceFieldInfoFromServiceParam(defaultFieldType);
    }
    ...
    public boolean isRowSubmit() {
        ...
        return CheckField.ROW_SUBMIT_FIELD_NAME.equals(getName());
    }
