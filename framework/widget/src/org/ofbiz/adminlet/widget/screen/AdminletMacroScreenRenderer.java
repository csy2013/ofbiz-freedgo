...
public class AdminletMacroScreenRenderer extends MacroScreenRenderer {

    public static final String module = org.ofbiz.adminlet.widget.screen.AdminletMacroScreenRenderer.class.getName();

    public AdminletMacroScreenRenderer(String name, String macroLibraryPath) throws TemplateException, IOException {
