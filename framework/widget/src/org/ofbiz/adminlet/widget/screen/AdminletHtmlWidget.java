 ...
 */
public class AdminletHtmlWidget extends HtmlWidget {
    public AdminletHtmlWidget(ModelScreen modelScreen, Element htmlElement) {
    ...
    public static class HtmlTemplateDecoratorSection extends HtmlWidget.HtmlTemplateDecoratorSection{
        ...
        public HtmlTemplateDecoratorSection(AdminletModelScreen modelScreen, Element htmlTemplateDecoratorSectionElement) {
            ...
            this.subWidgets = ModelScreenWidget.readSubWidgets(this.modelScreen, subElementList,"adminlet");
        }
