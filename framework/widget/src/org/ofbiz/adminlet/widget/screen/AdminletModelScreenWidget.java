...
import org.ofbiz.adminlet.widget.html.AdminletHtmlFormRenderer;
import org.ofbiz.adminlet.widget.html.AdminletHtmlMenuRenderer;
...
public abstract class AdminletModelScreenWidget extends ModelScreenWidget {

    public static final String module = AdminletModelScreenWidget.class.getName();
    ...
    public static final String extend = "adminlet";
//    public static final String contarea = "contentarea";

    public AdminletModelScreenWidget(AdminletModelScreen modelScreen, Element widgetElement) {
    ...
    public static void renderSubWidgetsString(List<ModelScreenWidget> subWidgets, Appendable writer, Map<String, Object> context, ScreenStringRenderer screenStringRenderer) throws GeneralException, IOException {
        ...
        for (int i = 0; i < subWidgets.size(); i++) {
            ...
            if(i==(subWidgets.size()-1)){
                //add by changsy 2015/2/5 adminlet 设置 am-g 是最后一个div class add am-g-end
    ...
    public static class Container extends ModelScreenWidget.Container {
        ...
        public Container(AdminletModelScreen modelScreen, Element containerElement) {
            super(modelScreen, containerElement);
            // read sub-widgets
            List<? extends Element> subElementList = UtilXml.childElementList(containerElement);
            this.subWidgets = AdminletModelScreenWidget.readSubWidgets(this.modelScreen, subElementList, "adminlet");
        }
        ...
        public String getStyle(Map<String, Object> context) {
            ...
            if (style.equals("contentarea")) {
                String contentStyle = UtilProperties.getPropertyValue("adminlet.properties", "admin.content");
                style = contentStyle;
            }else if(id.equals("left-column")){
                style = UtilProperties.getPropertyValue("adminlet.properties","admin.default.container.style");
//                style = style + " am-fr";
            }else if(id.equals("centerdiv")){
                style = UtilProperties.getPropertyValue("adminlet.properties","admin.default.container.style");
//                style = style + " am-fl";
            }else if(style.equals("lefthalf")){
                style = UtilProperties.getPropertyValue("adminlet.properties", "admin.default.container.half.style");
//                style = style + " am-fl";
...
//                style = style + " am-fl";
        ...
        public void renderWidgetString(Appendable writer, Map<String, Object> context, ScreenStringRenderer screenStringRenderer) throws GeneralException, IOException {
           ...
           /* if(this.styleExdr.expandString(context)!=null && this.styleExdr.expandString(context).equals("clear")){
            ...
            try {
//                screenStringRenderer = new AdminletMacroScreenRenderer(UtilProperties.getPropertyValue("widget.properties", getName() + ".name"), UtilProperties.getPropertyValue("widget", getName() + ".screenrenderer"));
    ...
    public static class Menu extends ModelScreenWidget.Menu {
        ...
        public Menu(AdminletModelScreen modelScreen, Element menuElement) {
        ...
        public void renderWidgetString(Appendable writer, Map<String, Object> context, ScreenStringRenderer screenStringRenderer) throws IOException {
            ...
            if (menuStringRenderer == null) {
                ...
                if (request != null && response != null) {
                    menuStringRenderer = new AdminletHtmlMenuRenderer(request, response);
                }
            }
    ...
    public static class DecoratorSection extends ModelScreenWidget.DecoratorSection {
        ...
        public DecoratorSection(AdminletModelScreen modelScreen, Element decoratorSectionElement) {
    ...
    public static class ColumnContainer extends ModelScreenWidget.ColumnContainer {
        public ColumnContainer(AdminletModelScreen modelScreen, Element containerElement) {
            super(modelScreen, containerElement);
    ...
    public static class Column extends ModelScreenWidget.Column {
        ...
        public Column(AdminletModelScreen modelScreen, Element containerElement) {
            super(modelScreen, containerElement);
    ...
    public static class Screenlet extends ModelScreenWidget.Screenlet {
        ...
        public Screenlet(AdminletModelScreen modelScreen, Element screenletElement) {
    ...
    public static class Section extends ModelScreenWidget.Section {
        ...
        public Section(AdminletModelScreen modelScreen, Element sectionElement) {
    ...
    public static class DecoratorScreen extends ModelScreenWidget.DecoratorScreen {
        ...
        public DecoratorScreen(AdminletModelScreen modelScreen, Element decoratorScreenElement) {
            ...
            for (Element decoratorSectionElement : decoratorSectionElementList) {
                DecoratorSection decoratorSection = new org.ofbiz.adminlet.widget.screen.AdminletModelScreenWidget.DecoratorSection(modelScreen, decoratorSectionElement);
        ...
        public void renderWidgetString(Appendable writer, Map<String, Object> context, ScreenStringRenderer screenStringRenderer) throws GeneralException, IOException {
            ...
            org.ofbiz.adminlet.widget.screen.AdminletModelScreenWidget.SectionsRenderer sections = new org.ofbiz.adminlet.widget.screen.AdminletModelScreenWidget.SectionsRenderer(this.sectionMap, standAloneStack, writer, screenStringRenderer);
            ...
            ScreenFactory.renderReferencedScreen(name, location, this, writer, context, screenStringRenderer, "adminlet");
    ...
    public static class IncludeScreen extends ModelScreenWidget.IncludeScreen {
        ...
        public IncludeScreen(AdminletModelScreen modelScreen, Element includeScreenElement) {
    ...
    public static class HorizontalSeparator extends ModelScreenWidget.HorizontalSeparator {
        ...
        public HorizontalSeparator(AdminletModelScreen modelScreen, Element separatorElement) {
    ...
    public static class DecoratorSectionInclude extends ModelScreenWidget.DecoratorSectionInclude {
        ...
        public DecoratorSectionInclude(AdminletModelScreen modelScreen, Element decoratorSectionElement) {
            super(modelScreen, decoratorSectionElement);
        }

        @Override
        public void renderWidgetString(Appendable writer, Map<String, Object> context, ScreenStringRenderer screenStringRenderer) throws GeneralException, IOException {
            if(this.name.equals("pre-body"))
            writer.append("<section class=\"content-header\">");
            ...
            if (preRenderedContent != null && preRenderedContent.containsKey(this.name)) {
                ...
                org.ofbiz.adminlet.widget.screen.AdminletModelScreenWidget.SectionsRenderer sections = (org.ofbiz.adminlet.widget.screen.AdminletModelScreenWidget.SectionsRenderer) context.get("sections");
    ...
    public static class Label extends ModelScreenWidget.Label {
        ...
        public Label(AdminletModelScreen modelScreen, Element labelElement) {
    ...
    public static class Form extends ModelScreenWidget.Form {
        ...
        public Form(AdminletModelScreen modelScreen, Element formElement) {
        ...
        public void renderWidgetString(Appendable writer, Map<String, Object> context, ScreenStringRenderer screenStringRenderer) {
            ...
            if (formStringRenderer == null) {
                ...
                HttpServletResponse response = (HttpServletResponse) context.get("response");
                if (request != null && response != null) {
                    formStringRenderer = new AdminletHtmlFormRenderer(request, response);
                }
            }
            // still null, throw an error
            if (formStringRenderer == null) {
    ...
    public static class Tree extends ModelScreenWidget.Tree {
        ...
        public Tree(AdminletModelScreen modelScreen, Element treeElement) {
    ...
    public static class PlatformSpecific extends ModelScreenWidget.PlatformSpecific {
        ...
        public PlatformSpecific(AdminletModelScreen modelScreen, Element platformSpecificElement) {
                ...
                if (childElements != null) {
                    for (Element childElement : childElements) {
                        if ("html".equals(childElement.getNodeName())) {
                            subWidgets.put("html", new org.ofbiz.adminlet.widget.screen.AdminletHtmlWidget(modelScreen, childElement));
                        } else if ("xsl-fo".equals(childElement.getNodeName())) {
                            subWidgets.put("xsl-fo", new org.ofbiz.adminlet.widget.screen.AdminletHtmlWidget(modelScreen, childElement));
                        } else if ("xml".equals(childElement.getNodeName())) {
                            subWidgets.put("xml", new AdminletHtmlWidget(modelScreen, childElement));
                        } else {
    ...
    public static class Content extends ModelScreenWidget.Content {
        ...
        public Content(AdminletModelScreen modelScreen, Element subContentElement) {
    ...
    public static class SubContent extends ModelScreenWidget.SubContent {
        ...
        public SubContent(AdminletModelScreen modelScreen, Element subContentElement) {
            super(modelScreen, subContentElement);
        }
    }
    ...
    public static class Link extends ModelScreenWidget.Link {
        ...
        public Link(AdminletModelScreen modelScreen, Element linkElement) {
    ...
    public static class Image extends ModelScreenWidget.Image {
        ...
        public Image(AdminletModelScreen modelScreen, Element imageElement) {
    ...
    public static class PortalPage extends ModelScreenWidget.PortalPage {
        ...
        public PortalPage(AdminletModelScreen modelScreen, Element portalPageElement) {
    ...
    public static class ModalPage extends ModelScreenWidget.ModalPage{
        ...
        public ModalPage(AdminletModelScreen modelScreen, Element element) {
