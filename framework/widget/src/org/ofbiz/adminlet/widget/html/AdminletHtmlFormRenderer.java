 ...
 */
public class AdminletHtmlFormRenderer extends org.ofbiz.widget.html.HtmlFormRenderer {

    protected AdminletHtmlFormRenderer() {}

    public AdminletHtmlFormRenderer(HttpServletRequest request, HttpServletResponse response) {
