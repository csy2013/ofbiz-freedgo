 ...
 */
public class AmazeHtmlFormRenderer extends org.ofbiz.widget.html.HtmlFormRenderer {

    protected AmazeHtmlFormRenderer() {}

    public AmazeHtmlFormRenderer(HttpServletRequest request, HttpServletResponse response) {
    ...
    public void renderNextPrev(Appendable writer, Map<String, Object> context, ModelForm modelForm) throws IOException {
         ...
         */
        writer.append("<div class=\"").append("am-container").append("\">");
        writer.append("<div class=\"").append("am-cf").append("\">");

        //  show row count
        writer.append("<div class=\"").append("am-fl").append("\">");
        writer.append(commonDisplaying);
        appendWhitespace(writer);
        writer.append("</div>");


        writer.append("<div class=\"").append("am-fr").append("\">");
        appendWhitespace(writer);
        writer.append(" <ul class=\"").append("am-pagination").append("\">");
        appendWhitespace(writer);
        String linkText;
        ...
        if (viewIndex > 0) {
            ...
            // disabled button
            writer.append(" class = \"am-disabled\">").append(modelForm.getPaginatePreviousLabel(context));
        }
        writer.append("</li>");
        appendWhitespace(writer);
        ...
        if (viewIndex > 0) {
            ...
            // disabled button
            writer.append(" class = \"am-disabled\">").append(modelForm.getPaginateFirstLabel(context));
        }
        writer.append("</li>");
        appendWhitespace(writer);
        ...
        if (highIndex < listSize) {
            ...
            // disabled button
            writer.append(" class=\"am-disabled\">").append(modelForm.getPaginateNextLabel(context));
        }
        writer.append("</li>");
        appendWhitespace(writer);
        ...
        if (highIndex < listSize) {
            ...
            // disabled button
            writer.append(" class=\"am-disabled\">").append(modelForm.getPaginateLastLabel(context));
        }
        writer.append("</li>");
        appendWhitespace(writer);
