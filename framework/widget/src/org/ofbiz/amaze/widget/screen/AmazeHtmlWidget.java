 ...
 */
public class AmazeHtmlWidget extends HtmlWidget {
    public AmazeHtmlWidget(ModelScreen modelScreen, Element htmlElement) {
    ...
    public static class HtmlTemplateDecoratorSection extends HtmlWidget.HtmlTemplateDecoratorSection{
        ...
        public HtmlTemplateDecoratorSection(AmazeModelScreen modelScreen, Element htmlTemplateDecoratorSectionElement) {
            ...
            this.subWidgets = ModelScreenWidget.readSubWidgets(this.modelScreen, subElementList,"amaze");
        }
