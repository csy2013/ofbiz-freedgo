...
public class AmazeMacroScreenRenderer extends MacroScreenRenderer {

    public static final String module = AmazeMacroScreenRenderer.class.getName();

    public AmazeMacroScreenRenderer(String name, String macroLibraryPath) throws TemplateException, IOException {
