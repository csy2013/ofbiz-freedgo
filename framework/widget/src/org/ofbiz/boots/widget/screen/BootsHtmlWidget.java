 ...
 */
public class BootsHtmlWidget extends HtmlWidget {
    public BootsHtmlWidget(ModelScreen modelScreen, Element htmlElement) {
    ...
    public static class HtmlTemplateDecoratorSection extends HtmlWidget.HtmlTemplateDecoratorSection{
        ...
        public HtmlTemplateDecoratorSection(BootsModelScreen modelScreen, Element htmlTemplateDecoratorSectionElement) {
            ...
            this.subWidgets = ModelScreenWidget.readSubWidgets(this.modelScreen, subElementList,"boots");
        }
