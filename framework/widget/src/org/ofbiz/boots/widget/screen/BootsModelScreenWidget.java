...
import org.ofbiz.boots.widget.html.BootsHtmlFormRenderer;
import org.ofbiz.boots.widget.html.BootsHtmlMenuRenderer;
...
public abstract class BootsModelScreenWidget extends ModelScreenWidget {

    public static final String module = BootsModelScreenWidget.class.getName();
    ...
    public static final String extend = "boots";
//    public static final String contarea = "contentarea";

    public BootsModelScreenWidget(BootsModelScreen modelScreen, Element widgetElement) {
    ...
    public static void renderSubWidgetsString(List<ModelScreenWidget> subWidgets, Appendable writer, Map<String, Object> context, ScreenStringRenderer screenStringRenderer) throws GeneralException, IOException {
        ...
        for (int i = 0; i < subWidgets.size(); i++) {
            ...
            if(i==(subWidgets.size()-1)){
                //add by changsy 2015/2/5 boots 设置 am-g 是最后一个div class add am-g-end
    ...
    public static class Container extends ModelScreenWidget.Container {
        ...
        public Container(BootsModelScreen modelScreen, Element containerElement) {
            super(modelScreen, containerElement);
            // read sub-widgets
            List<? extends Element> subElementList = UtilXml.childElementList(containerElement);
            this.subWidgets = BootsModelScreenWidget.readSubWidgets(this.modelScreen, subElementList, "boots");
        }
        ...
        public String getStyle(Map<String, Object> context) {
            ...
            if (style.equals("contentarea")) {
                String contentStyle = UtilProperties.getPropertyValue("boots.properties", "admin.content");
                style = contentStyle;
            }else if(id.equals("left-column")){
                style = UtilProperties.getPropertyValue("boots.properties","admin.default.container.style");
//                style = style + " am-fr";
            }else if(id.equals("centerdiv")){
                style = UtilProperties.getPropertyValue("boots.properties","admin.default.container.style");
//                style = style + " am-fl";
            }else if(style.equals("lefthalf")){
                style = UtilProperties.getPropertyValue("boots.properties", "admin.default.container.half.style");
//                style = style + " am-fl";
...
//                style = style + " am-fl";
        ...
        public void renderWidgetString(Appendable writer, Map<String, Object> context, ScreenStringRenderer screenStringRenderer) throws GeneralException, IOException {
           ...
           /* if(this.styleExdr.expandString(context)!=null && this.styleExdr.expandString(context).equals("clear")){
            ...
            try {
//                screenStringRenderer = new BootsMacroScreenRenderer(UtilProperties.getPropertyValue("widget.properties", getName() + ".name"), UtilProperties.getPropertyValue("widget", getName() + ".screenrenderer"));
                String id = getId(context);
                if (id.equals("left-column") || (id.equals("cmsnav"))) {
                    writer.append("<div class=\"row\">");
                    writer.append("<div class=\"col-md-4 col-lg-4 clearfix pull-left\">");
                } else if (id.equals("centerdiv") || id.equals("cmsmain")) {
                    writer.append("<div class=\"col-md-8 col-lg-8 clearfix pull-right\">");
                }
    ...
    public static class Menu extends ModelScreenWidget.Menu {
        ...
        public Menu(org.ofbiz.boots.widget.screen.BootsModelScreen modelScreen, Element menuElement) {
        ...
        public void renderWidgetString(Appendable writer, Map<String, Object> context, ScreenStringRenderer screenStringRenderer) throws IOException {
            ...
            if (menuStringRenderer == null) {
                ...
                if (request != null && response != null) {
                    menuStringRenderer = new BootsHtmlMenuRenderer(request, response);
                }
            }
    ...
    public static class DecoratorSection extends ModelScreenWidget.DecoratorSection {
        ...
        public DecoratorSection(org.ofbiz.boots.widget.screen.BootsModelScreen modelScreen, Element decoratorSectionElement) {
    ...
    public static class ColumnContainer extends ModelScreenWidget.ColumnContainer {
        public ColumnContainer(org.ofbiz.boots.widget.screen.BootsModelScreen modelScreen, Element containerElement) {
            super(modelScreen, containerElement);
        ...
        @Override
        public void renderWidgetString(Appendable writer, Map<String, Object> context, ScreenStringRenderer screenStringRenderer) throws GeneralException, IOException {
             super.renderWidgetString(writer,context,screenStringRenderer);
        }
    ...
    public static class Column extends ModelScreenWidget.Column {

        public Column(org.ofbiz.boots.widget.screen.BootsModelScreen modelScreen, Element containerElement) {
            super(modelScreen, containerElement);
    ...
    public static class Screenlet extends ModelScreenWidget.Screenlet {
        ...
        public Screenlet(org.ofbiz.boots.widget.screen.BootsModelScreen modelScreen, Element screenletElement) {
    ...
    public static class Section extends ModelScreenWidget.Section {
        ...
        public Section(org.ofbiz.boots.widget.screen.BootsModelScreen modelScreen, Element sectionElement) {
    ...
    public static class DecoratorScreen extends ModelScreenWidget.DecoratorScreen {
        ...
        public DecoratorScreen(org.ofbiz.boots.widget.screen.BootsModelScreen modelScreen, Element decoratorScreenElement) {
            ...
            for (Element decoratorSectionElement : decoratorSectionElementList) {
                DecoratorSection decoratorSection = new org.ofbiz.boots.widget.screen.BootsModelScreenWidget.DecoratorSection(modelScreen, decoratorSectionElement);
        ...
        public void renderWidgetString(Appendable writer, Map<String, Object> context, ScreenStringRenderer screenStringRenderer) throws GeneralException, IOException {
            ...
            org.ofbiz.boots.widget.screen.BootsModelScreenWidget.SectionsRenderer sections = new org.ofbiz.boots.widget.screen.BootsModelScreenWidget.SectionsRenderer(this.sectionMap, standAloneStack, writer, screenStringRenderer);
            ...
            ScreenFactory.renderReferencedScreen(name, location, this, writer, context, screenStringRenderer, "boots");
    ...
    public static class IncludeScreen extends ModelScreenWidget.IncludeScreen {
        ...
        public IncludeScreen(org.ofbiz.boots.widget.screen.BootsModelScreen modelScreen, Element includeScreenElement) {
    ...
    public static class HorizontalSeparator extends ModelScreenWidget.HorizontalSeparator {
        ...
        public HorizontalSeparator(org.ofbiz.boots.widget.screen.BootsModelScreen modelScreen, Element separatorElement) {
    ...
    public static class DecoratorSectionInclude extends ModelScreenWidget.DecoratorSectionInclude {
        ...
        public DecoratorSectionInclude(org.ofbiz.boots.widget.screen.BootsModelScreen modelScreen, Element decoratorSectionElement) {
            super(modelScreen, decoratorSectionElement);
        }
        ...
        public void renderWidgetString(Appendable writer, Map<String, Object> context, ScreenStringRenderer screenStringRenderer) throws GeneralException, IOException {
            ...
            if (preRenderedContent != null && preRenderedContent.containsKey(this.name)) {
                ...
                org.ofbiz.boots.widget.screen.BootsModelScreenWidget.SectionsRenderer sections = (org.ofbiz.boots.widget.screen.BootsModelScreenWidget.SectionsRenderer) context.get("sections");
    ...
    public static class Label extends ModelScreenWidget.Label {
        ...
        public Label(org.ofbiz.boots.widget.screen.BootsModelScreen modelScreen, Element labelElement) {
    ...
    public static class Form extends ModelScreenWidget.Form {
        ...
        public Form(org.ofbiz.boots.widget.screen.BootsModelScreen modelScreen, Element formElement) {
        ...
        public void renderWidgetString(Appendable writer, Map<String, Object> context, ScreenStringRenderer screenStringRenderer) {
            ...
            if (formStringRenderer == null) {
                ...
                HttpServletResponse response = (HttpServletResponse) context.get("response");
                if (request != null && response != null) {
                    formStringRenderer = new BootsHtmlFormRenderer(request, response);
                }
            }
            // still null, throw an error
            if (formStringRenderer == null) {
    ...
    public static class Tree extends ModelScreenWidget.Tree {
        ...
        public Tree(org.ofbiz.boots.widget.screen.BootsModelScreen modelScreen, Element treeElement) {
    ...
    public static class PlatformSpecific extends ModelScreenWidget.PlatformSpecific {
        ...
        public PlatformSpecific(org.ofbiz.boots.widget.screen.BootsModelScreen modelScreen, Element platformSpecificElement) {
                ...
                if (childElements != null) {
                    for (Element childElement : childElements) {
                        if ("html".equals(childElement.getNodeName())) {
                            subWidgets.put("html", new BootsHtmlWidget(modelScreen, childElement));
                        } else if ("xsl-fo".equals(childElement.getNodeName())) {
                            subWidgets.put("xsl-fo", new BootsHtmlWidget(modelScreen, childElement));
                        } else if ("xml".equals(childElement.getNodeName())) {
                            subWidgets.put("xml", new BootsHtmlWidget(modelScreen, childElement));
                        } else {
    ...
    public static class Content extends ModelScreenWidget.Content {
        ...
        public Content(org.ofbiz.boots.widget.screen.BootsModelScreen modelScreen, Element subContentElement) {
    ...
    public static class SubContent extends ModelScreenWidget.SubContent {
        ...
        public SubContent(org.ofbiz.boots.widget.screen.BootsModelScreen modelScreen, Element subContentElement) {
            super(modelScreen, subContentElement);
        }
    }
    ...
    public static class Link extends ModelScreenWidget.Link {
        ...
        public Link(org.ofbiz.boots.widget.screen.BootsModelScreen modelScreen, Element linkElement) {
    ...
    public static class Image extends ModelScreenWidget.Image {
        ...
        public Image(org.ofbiz.boots.widget.screen.BootsModelScreen modelScreen, Element imageElement) {
    ...
    public static class PortalPage extends ModelScreenWidget.PortalPage {
        ...
        public PortalPage(BootsModelScreen modelScreen, Element portalPageElement) {
    ...
    public static class ModalPage extends ModelScreenWidget.ModalPage{

        public ModalPage(BootsModelScreen modelScreen, Element element) {
