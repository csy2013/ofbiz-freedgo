 ...
 * under the License.
 *******************************************************************************/
package org.ofbiz.boots.widget.html;
 ...
 */
public class BootsHtmlMenuRenderer extends HtmlMenuRenderer {

    HttpServletRequest request;
    HttpServletResponse response;

    public BootsHtmlMenuRenderer(HttpServletRequest request, HttpServletResponse response) {
    ...
    public void renderMenuOpen(Appendable writer, Map<String, Object> context, ModelMenu modelMenu) throws IOException {
        ...
        if (UtilValidate.isNotEmpty(menuId)) {
            ...
            String menu_div = UtilProperties.getPropertyValue("boots.properties", "admin.appbar.div");
            ...
            appendWhitespace(writer);
             ...
             if(menuContainerStyle.indexOf("tab-bar")!=-1) {
                 String secondBarNav = UtilProperties.getPropertyValue("boots.properties", "admin.secondbar.nav");
        ...
        if (modelMenu.renderedMenuItemCount(context) > 0) {
            String admin_menu_ul = UtilProperties.getPropertyValue("boots.properties", "admin.appbar.ul");
            if (UtilValidate.isEmpty(menuId)) {
                //使用Boots menu
                if(menuContainerStyle.indexOf("tab-bar")!=-1) {
                String barStyle = UtilProperties.getPropertyValue("boots.properties", "admin.secondbar.ul");
