 ...
 */
public class BootsHtmlFormRenderer extends org.ofbiz.widget.html.HtmlFormRenderer {

    protected BootsHtmlFormRenderer() {}

    public BootsHtmlFormRenderer(HttpServletRequest request, HttpServletResponse response) {
