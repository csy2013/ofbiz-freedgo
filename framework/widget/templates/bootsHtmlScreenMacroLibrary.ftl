...
<#--<div class="row">
<div class="col-md-12">-->
<div class="ibox<#if style==""> float-e-margins<#else>${style}</#if>" <#if id?has_content> id="${id}"</#if> data-sortable-id="form-stuff-${id}"><#rt/>
    <#if showMore>
    ...
    ${menuString}
     ...
     -->
        <#if menuString?has_content>
            <div class="ibox-content">${menuString}</div>
        </#if>
    </#if>
...
<#macro renderConfirmField id name  confirmUrl buttonType="" className="" buttonStyle="" buttonSpanStyle=""  alert="false" description=""  ajaxEnabled="" presentation="layer" height="" width=""  position="" fadeBackground="true" clearText=""   confirmMessage="" confirmTitle="" targetParameterIter="" returnUrl="" returnParameters="">
    <#if Static["org.ofbiz.widget.ModelWidget"].widgetBoundaryCommentsEnabled(context)>
    <!-- @renderLookupField -->
    </#if>
    <#if buttonType=="text-link">
