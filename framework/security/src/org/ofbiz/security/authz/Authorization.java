...
public interface Authorization {
     ...
     */
    boolean hasPermission(String userId, String permission, Map<String, ? extends Object> context);
     ...
     * @return true if the user has permission
     */
    boolean hasPermission(HttpSession session, String permission, Map<String, ? extends Object> context);
     ...
     */
    Map<String, Boolean> findMatchingPermission(String userId, String permissionRegexp, Map<String, ? extends Object> context);
