 ...
 */
public class CatalinaContainer1 implements Container {
    ...
    public static final String module = CatalinaContainer1.class.getName();
    ...
    public void init(String[] args, String configFile) throws ContainerException {
      ...
      /*      //增加ARP Listener product on
        ...
        listener.setSSLEngine("on"); //y
        server.addLifecycleListener(listener);*/

        // 增加对tomcat的性能优化部分
        List<Property> executorProps = cc.getPropertiesWithValue("executor");
        if (!UtilValidate.isEmpty(executorProps)) {
            for (Property executorProp : executorProps) {
        ...
        for (Property engineProp : engineProps) {
                ...
                for (Property prop : connectorProp.properties.values()) {
                    ...
                    if(prop.name.equals("executor")) {
                        ...
                        if (m != null) {
                            ...
                            m.invoke(connector.getProtocolHandler(), new Object[]{ex});
                        } else {
    ...
    protected Executor createExecutor(Property executorProp) throws ContainerException {
        if (tomcat == null) {
            throw new ContainerException("Cannot load web applications without Tomcat instance!");
        }
