...
public class UelUtil {
     ...
     * to the specified value.
     * @param context Evaluation context (variables)
     * @param expectedClassType The expected object Class to set
     * @throws <code>javax.el.*</code> exceptions
     */
    @SuppressWarnings("unchecked")
    public static void setValue(Map<String, Object> context, String expectedClassType, Object value) {
        try {
            setValue(context,"${uiLabelMap}",Class.forName(expectedClassType),value);
