...
public final class JsLanguageFilesMapping {
    ...
    public static class formParsley {
        ...
        static {
            localeFiles.put("en","/images/themes/coloradmin/plugins/parsley/dist/i18n/en.js");
            localeFiles.put("zh", "/images/themes/coloradmin/plugins/parsley/dist/i18n/zh_cn.js");
            localeFiles.put("zh_CN", "/images/themes/coloradmin/plugins/parsley/dist/i18n/zh_cn.js");

        }

        public static String getFilePath(String locale) {
            if (formParsley.localeFiles.get(locale) == null) {
                return datejs.defaultDateJs;
            }
            return formParsley.localeFiles.get(locale);
        }
    ...
    public static class datejs {
        ...
        static {
            ...
            localeFiles.put("zh", "/images/jquery/plugins/datejs/date-zh-CN.js");
    ...
    public static class jquery {
        private static Map<String, String> localeFiles = FastMap.newInstance();
        private static Map<String, String> jqueryVersions = FastMap.newInstance();
        private static Map<String, String> jqueryUiVersions = FastMap.newInstance();

        static {
            jqueryVersions.put("2.1","/images/jquery/jquery-2.1.1.js");
            jqueryVersions.put("1.10","/images/jquery/jquery-1.10.2.js");
            jqueryVersions.put("1.7","/images/jquery/jquery-1.7.js");
            jqueryVersions.put("2.1.4","/images/themes/adminlet/js/plugins/jQuery/jQuery-2.1.4.min.js");
            jqueryVersions.put("1.9.1_coloradmin","/images/themes/coloradmin/plugins/jquery/jquery-1.9.1.min.js");
        }
        static {
            jqueryUiVersions.put("1.8.16","/images/jquery/ui/js/jquery-ui-1.8.16.custom.min.js");
            jqueryUiVersions.put("1.11.4","/images/jquery/ui/jquery-ui-1.11.4.custom/jquery-ui.js");
            jqueryUiVersions.put("1.10.4_coloradmin","/images/themes/coloradmin/plugins/jquery-ui/ui/minified/jquery-ui.min.js");
        }


        public static String getJqueryVersion(String visualThemeId) {
            if (visualThemeId.equals("BOOTS") || visualThemeId.equals("AMAZE")) {
                return jquery.jqueryVersions.get("2.1.4");
            }else if(visualThemeId.equals("ADMINLET")){
                return jquery.jqueryVersions.get("2.1.4");
            }else if(visualThemeId.equals("COLORADMIN")){
                return jquery.jqueryVersions.get("1.9.1_coloradmin");
            }
            return jquery.jqueryVersions.get("1.7");
        }

        public static String getJqueryUiVersion(String visualThemeId) {
            if (visualThemeId.equals("BOOTS") || visualThemeId.equals("AMAZE")) {
                return jquery.jqueryUiVersions.get("1.11.4");
            }else if(visualThemeId.equals("ADMINLET")){
                return jquery.jqueryUiVersions.get("1.11.4");
            }else if(visualThemeId.equals("COLORADMIN")){
                return jquery.jqueryUiVersions.get("1.11.4");
//                return jquery.jqueryUiVersions.get("1.10.4_coloradmin");
            }
            return jquery.jqueryUiVersions.get("1.8.16");
        }

        public static String getMaskedInput(String visualThemeId){
            if(visualThemeId.equals("BOOTS") || visualThemeId.equals("AMAZE") || visualThemeId.equals("ADMINLET")){
                return null;
            }else if(visualThemeId.equals("COLORADMIN")){
                return null;
            }
            return "/images/jquery/plugins/jquery.maskedinput-1.2.2.min.js";
        }
        ...
        static {
            ...
            localeFiles.put("zh", "/images/jquery/ui/development-bundle/ui/i18n/jquery.ui.datepicker-zh-CN.js");
    ...
    public static class validation {
        ...
        static {
            ...
            localeFiles.put("zh", "/images/jquery/plugins/validate/localization/messages_cn.js");
    ...
    public static class dateTime {
        ...
        static {
            ...
            localeFiles.put("zh", "/images/jquery/plugins/datetimepicker/localization/jquery-ui-timepicker-zh-CN.js");
