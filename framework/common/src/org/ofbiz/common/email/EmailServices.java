...
public class EmailServices {
    ...
    public static Map<String, Object> sendMail(DispatchContext ctx, Map<String, ? extends Object> context) {
        ...
        if (sendType == null || sendType.equals("mail.smtp.host")) {
            ...
            if (sendPartial == null) {
                sendPartial = EntityUtilProperties.propertyValueEqualsIgnoreCase("general.properties", "mail.smtp.sendpartial", "true", delegator);
            }
...
//                SmtpAuthenticator smtpAuth=new SmtpAuthenticator(authUser,authPass);
...
//            }
            ...
            mail.setHeader("X-Mailer", "YaBiz Project");
