...
<div id="footer">
    <ul>
        <li class="first">${nowTimestamp?datetime?string.short} - <a
                href="<@ofbizUrl>ListTimezones</@ofbizUrl>">${timeZone.getDisplayName(timeZone.useDaylightTime(), Static["java.util.TimeZone"].LONG, locale)}</a></li>
    ...
    <p>
    ${uiLabelMap.CommonCopyright} (c) 2001-${nowTimestamp?string("yyyy")} <a href="http://www.apache.org" target="_blank">yuaoq</a>. ${uiLabelMap.CommonPoweredBy} <a
            href="http://ofbiz.apache.org" target="_blank">yuaoq.</a>
    </p>
</div>
</div>
