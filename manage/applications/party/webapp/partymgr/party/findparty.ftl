        ...
        <div class="form-group">
            ...
            <div class= "input-group m-b-10 m-r-5"><span class="input-group-addon">${uiLabelMap.PartyType}</span>
                ...
                <#list partyTypes as partyType>
                    <#if partyType.partyTypeId=='PERSON'|| partyType.partyTypeId=='CARRIER' || partyType.partyTypeId=='SUPPLIER' || partyType.partyTypeId=='BROKER'
                    || partyType.partyTypeId=="PARTNER" ||partyType.partyTypeId=="PARTNER_PERSON">
...
<#if partyList?exists>
    ...
    <div class="button-bar"><a href="<@ofbizUrl>${createUrl}</@ofbizUrl>" class="btn btn-primary btn-sm">${uiLabelMap.CommonCreateNew}</a></div>
    </#if>
        ...
        <#assign commonDisplaying = Static["org.ofbiz.base.util.UtilProperties"].getMessage("CommonUiLabels", "CommonDisplaying", messageMap, locale)/>
          ...
          <#if partyRelateCom?has_content>
              ...
              ${mainRole.description?if_exists}
                        ...
                        <td><#if partyDate.createdDate??>${partyDate.createdDate?string("yyyy-MM-dd HH:mm")}</#if></td>
                        <td><#if partyDate.lastModifiedDate??>${partyDate.lastModifiedDate?string("yyyy-MM-dd HH:mm")?default("")}</#if></td>
                        <td class="button-col align-float">
                          ...
                          <#--  <#if security.hasEntityPermission("ORDERMGR", "_VIEW", session)>
                           ...
                           <#-- <#if security.hasEntityPermission("ORDERMGR", "_CREATE", session)>
                            ...
                            confirmTitle="删除会员" confirmMessage="确定删除该会员" targetParameterIter="partyId:'${partyRow.partyId}'"
