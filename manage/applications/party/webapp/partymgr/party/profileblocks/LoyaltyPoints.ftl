...
-->
  ...
  <#if monthsToInclude?exists && totalSubRemainingAmount?exists && totalOrders?exists>
    <#--<div id="totalOrders" class="panel panel-inverse">-->
        <@htmlScreenTemplate.renderScreenletBegin id="totalOrders" title="${uiLabelMap.PartyLoyaltyPoints}"/>
      <#--<div class="panel-heading">
         <h4 class="panel-title"> ${uiLabelMap.PartyLoyaltyPoints}  </h4>
      </div>
