...
<div class="am-cf am-padding-xs">
    <div id="partyUserLogins" class="am-panel am-panel-default">
        ...
        <#if security.hasEntityPermission("PARTYMGR", "_CREATE", session) || userLogin.partyId == partyId>
           <div  class="am-u-lg-2"><a href="<@ofbizUrl>editcontactmech?partyId=${partyId}</@ofbizUrl>">${uiLabelMap.CommonCreateNew}</a></div>
        </#if>
      </div>
      <br class="clear" />
            ...
            <tr>
              ...
              <td class="button-col">
                <#if security.hasEntityPermission("PARTYMGR", "_UPDATE", session) || userLogin.partyId == partyId>
                  <a class="am-btn am-btn-primary am-btn-sm" href="<@ofbizUrl>editcontactmech?partyId=${partyId}&amp;contactMechId=${contactMech.contactMechId}</@ofbizUrl>">${uiLabelMap.CommonUpdate}</a>
                </#if><br/><br/>
