  ...
  <div class="am-cf am-padding-xs">
    <div id="partyUserLogins" class="am-panel am-panel-default">
        <div class="am-panel-hd am-cf">
            <div class="am-u-lg-5">${uiLabelMap.PartyPaymentMethodInformation}</div>
        <#if security.hasEntityPermission("PAY_INFO", "_CREATE", session)>
        <div class="am-u-lg-7"><a href="<@ofbizUrl>editeftaccount?partyId=${partyId}</@ofbizUrl>">${uiLabelMap.AccountingCreateNewEftAccount}</a>&nbsp;&nbsp;
        <a href="<@ofbizUrl>editgiftcard?partyId=${partyId}</@ofbizUrl>">${uiLabelMap.AccountingCreateNewGiftCard}</a>&nbsp;&nbsp;
        <a href="<@ofbizUrl>editcreditcard?partyId=${partyId}</@ofbizUrl>">${uiLabelMap.AccountingCreateNewCreditCard}</a>&nbsp;&nbsp;
        <a href="<@ofbizUrl>EditBillingAccount?partyId=${partyId}</@ofbizUrl>">${uiLabelMap.AccountingCreateBillingAccount}</a></div>
        </#if>
        </div>
      <br class="clear" />
    ...
    <div class="am-panel-bd am-collapse am-in">
      <#if paymentMethodValueMaps?has_content || billingAccounts?has_content>
        <table style="border-collapse: separate;border-spacing: 0;margin-bottom: 1.6rem;width: 100%;" cellspacing="0">
