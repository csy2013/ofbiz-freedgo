...
<form method="post" name="lookupparty" action="<@ofbizUrl>findparty</@ofbizUrl>" class="form-inline" id="lookupparty">
        ...
        <div class="form-group">
            ...
            <input type="hidden" name="partyTypeId" value="PARTNER_PERSON"/>
...
<#if partyList?exists>
   ...
   <#-- <#if (parameters.firstName?has_content || parameters.lastName?has_content)>
    ...
    <div class="button-bar">
        <a href="<@ofbizUrl>NewPartnerPerson</@ofbizUrl>" class="btn btn-primary btn-sm">${uiLabelMap.CommonCreateNew}</a>
     <#--<@htmlScreenTemplate.renderModalPage description="${uiLabelMap.CommonCreateNew}" id="addPartyPerson" name="addPartyPerson" modalUrl="addPartyPerson"
        modalTitle="新建对应的员工"/>-->
    </div>
    </#if>
                        ...
                        <td class="button-col align-float">
                          ...
                          <#--  <#if security.hasEntityPermission("ORDERMGR", "_VIEW", session)>
                           ...
                           <#-- <#if security.hasEntityPermission("ORDERMGR", "_CREATE", session)>
                            ...
                            confirmTitle="删除外部员工" confirmMessage="确定删除该外部员工" targetParameterIter="partyId:'${partyRow.partyId}'"
