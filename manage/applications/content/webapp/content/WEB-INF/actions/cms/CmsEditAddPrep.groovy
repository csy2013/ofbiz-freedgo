...
if (contentAssoc) {
    SimpleMapProcessor.runSimpleMapProcessor("component://contentService/script/org/ofbiz/content/ContentManagementMapProcessors.xml", "contentAssocOut", contentAssoc, contentAssocDataResourceViewFrom, new ArrayList(), Locale.getDefault())
} else {
    contentAssocPK.setAllFields(context, false, "ca", null) //set all field, pk and non
    SimpleMapProcessor.runSimpleMapProcessor("component://contentService/script/org/ofbiz/content/ContentManagementMapProcessors.xml", "contentAssocOut", contentAssocPK, contentAssocDataResourceViewFrom, new ArrayList(), Locale.getDefault())
}
...
if (dataResourceId) {
    ...
    SimpleMapProcessor.runSimpleMapProcessor("component://contentService/script/org/ofbiz/content/ContentManagementMapProcessors.xml", "dataResourceOut", dataResource, contentAssocDataResourceViewFrom, new ArrayList(), Locale.getDefault())
    templateRoot = [:]
