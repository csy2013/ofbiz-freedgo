...
<#--<script language="javascript" type="text/javascript" src="<@ofbizContentUrl>/images/jquery/plugins/elrte-1.3/js/elrte.full.js</@ofbizContentUrl>"></script>-->
<script language="javascript" type="text/javascript" src="<@ofbizContentUrl>/images/ckeditor/ckeditor.js</@ofbizContentUrl>"></script>
...
<script type="text/javascript">
    window.CKEDITOR_BASEPATH='<@ofbizContentUrl>/images/ckeditor/ckeditor/</@ofbizContentUrl>';
...
<#-------------------------------------------------------------------------------------createEditor function-->
    function createEditor() {
     /*  if($('#cmseditor').length) {
        ...
        if($('#cmsdata').length) {
            if (!CKEDITOR.instances['cmsdata']) {
                CKEDITOR.replace('cmsdata', {
                            language: '${language}'
                        }
                );
            } else {
                var editor2 = CKEDITOR.instances['cmsdata'];
