...
<form action="<@ofbizUrl>updateActivityAct</@ofbizUrl>" method="post">
    ...
    <div class="table-responsive">
        <table id="data-table" class="acttable table table-striped table-bordered">
            ...
            <tr class="picbody">
                ...
                <td> <input type="text" id="upload${seq}_advertContentName" name="upload${seq}_advertContentName" value=""/> </td>
                <td> <input type="text" id="upload${seq}_description" name="upload${seq}_description" value=""/> </td>
                <td>
        ...
        $('.picNumStyle').change(function(){
            ...
            for (var j=0;j<num;j++) {
                 var html = '<tr class="picbody"> <td>'+(j+1)+'</td> <td> <input type="hidden" id="upload'+(j+1)+'_imgSrc" name="upload'+(j+1)+'_imgSrc"/> <input type="hidden" id="upload'+(j+1)+'_sequenceNum" name="upload'+(j+1)+'_sequenceNum" value="'+(j+1)+'"/>'+
                        '<a href="javascript:void(0)" id="upload'+(j+1)+'" class="uploadbanner btn btn-primary">选择图片</a> </td> <td> <input type="text" id="upload'+(j+1)+'_advertContentName" name="upload'+(j+1)+'_advertContentName" value=""/> </td>'+
                        '<td> <input type="text" id="upload'+(j+1)+'_description" name="upload'+(j+1)+'_description" value=""/> </td><td> <select id="upload'+(j+1)+'_linkType" name="upload'+(j+1)+'_linkType" class="uploadLinkType">'+
