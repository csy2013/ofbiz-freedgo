...
<form action="<@ofbizUrl>updateActivityProduct5</@ofbizUrl>" method="post">
    ...
    <div class="row">
        <div class="control-label col-md-2">图片名称:</div>
    ...
    <div class="table-responsive">
        <table id="data-table" class="table table-striped table-bordered">
            ...
            <tr>
                ...
                <td>
                    <input type="hidden" id="upload${advertContent.sequenceNum}_imgSrc" name="upload${advertContent.sequenceNum}_imgSrc"/>
                    <input type="hidden" id="upload${advertContent.sequenceNum}_sequenceNum" name="upload${advertContent.sequenceNum}_sequenceNum" value="${advertContent.sequenceNum}"/>
                ...
                <td>
                    <input type="text" name="upload${advertContent.sequenceNum}_val" id="upload${advertContent.sequenceNum}_val" class="upload_val form-control" size="8" value="${advertContent.relationId}"/>
                </td>
            </tr>
            </#list>
            </thead>
...
<script type="application/javascript">
    ...
    $(".upload_val").click(function () {
        ...
        if (type === 'channelPage') {
            ...
            art.dialog.open('<@ofbizUrl>LookupProducts</@ofbizUrl>', {
                id: this.id,
                lock: true,
                width: '800px',
                height: '600px',
