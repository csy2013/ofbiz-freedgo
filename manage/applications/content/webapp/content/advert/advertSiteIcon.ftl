<div class="row">
    <div class="col-md-2">
    <#if iconAdvertContents?has_content>
      <#assign siteIcon = iconAdvertContents.get(0) >
      ...
      <#assign fileName = linkContentWrapper.get('fileName')?if_exists/>
        <form action="<@ofbizUrl>uploadSiteIcon</@ofbizUrl>" class="dropzone dz-started" id="dropzoneSiteIcon" enctype="multipart/form-data">
            ...
            <div class="dz-preview dz-processing dz-image-preview dz-success dz-complete">
                ...
                <br/>
                <a class="dz-remove" href="javascript:onSiteIconDelete('#dropzoneSiteIcon',${siteIcon.get('advertContentId')});" data-dz-remove="">删除</a>
            <#--<div class="fallback">
    ...
    <#else>
        <form action="<@ofbizUrl>uploadSiteIcon</@ofbizUrl>" class="dropzone" id="dropzoneSiteIcon" enctype="multipart/form-data">
            <input type="hidden" name="webSiteId" value="${webSiteId}"/>
            <div class="fallback">
                <input name="uploadedFile" type="file"/>
            </div>
            ...
            var myDropzone = new Dropzone("#dropzoneSiteIcon", {
                ...
                init: function () {
                    ...
                    this.on("sending", function (file, xhr, formData) {
                        formData.append('relationUrl', $('#slidePic1').val())
                    });
