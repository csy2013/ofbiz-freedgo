...
<form action="<@ofbizUrl>updateBall</@ofbizUrl>" method="post">
    <input type="hidden" name="templateId" value="${siteIndexTemplateId}">
    <input type="hidden" name="advertId" value="${advertId}">
    <div class="row">
        <div class="control-label col-md-2"> 魔方名称:</div>
    ...
    <div class="table-responsive">
        <table id="data-table" class="table table-striped table-bordered">
            ...
            <tr>
                ...
                <td><input type="text" value="${advertContent.advertContentName}" name="upload${advertContent.sequenceNum}_advertContentName" class="form-control"/></td>
                <td>
                    ...
                    <#if advertContent.imgSrc?has_content><img src="${advertContent.imgSrc}" width="90"/> </#if>
            ...
            <#if advertContents?exists>
                <#assign size = advertContents.size()>
                <#if size<6>
                    <#list (size+1) ..6 as seq>
                    <tr>
                        <td>${seq}</td>
                        <td><input type="text" value="" name="upload${seq}_advertContentName"/></td>
                        <td>
...
<script type="application/javascript">
    ...
    function saveChoooseImage(path, id) {
        ...
        $('#' + id).before("<img src='" + path + "' width='90' />");
        $('#' + id + "_imgSrc").val(path);
