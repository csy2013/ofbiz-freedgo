...
<form action="<@ofbizUrl>createBall</@ofbizUrl>" method="post">
    ...
    <div class="table-responsive">
        <table id="data-table" class="table table-striped table-bordered">
            ...
            <tr>
                <td>${seq}</td>
                <td><input type="text" name="upload${seq}_advertContentName" id="upload${seq}_advertContentName" class="form-control" size="8"/></td>
                <td>
