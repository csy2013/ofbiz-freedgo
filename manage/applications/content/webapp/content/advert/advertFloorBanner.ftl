            ...
            <#list advertContents as adContent>
                <#if adContent.get('sequenceNum') == seq>
                    ...
                    <form action="<@ofbizUrl>uploadSiteSlide</@ofbizUrl>" class="dropzone dz-started" id="dropzone${seq}" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="advertTypeId" value="floorBanner"/>
...
<form name="slideRelationForm${seq}" class="form-horizontal form-bordered">
    <div class="form-group">
        ...
        <label class="control-label col-md-1" for="group${seq}">所属分组:</label>
        <div class="col-md-2">
            <#if advertContents?has_content>
                <#assign groupNum =""/>
                <#list advertContents as adContent>
        ...
        <label class="control-label col-md-1" for="group${seq}">所属子分组:</label>
        <div class="col-md-2">
            <#if advertContents?has_content>
                <#assign subGroupNum =""/>
                <#list advertContents as adContent>
            ...
            <input type="text" class="form-control" name="subGroupNum${seq}" id="subGroupNum${seq}" value="${subGroupNum?if_exists}"/>
        </div>
        <label class="control-label col-md-1" for="slidePic${seq}">地址:</label>
        <div class="col-md-2">
            <#if advertContents?has_content>
                <#assign relationUrl =""/>
                <#list advertContents as adContent>
