...
<div class="screenlet">
  ...
  <div class="screenlet-body">
    <form name="advToKeyWordSearchForm" method="post" action="<@ofbizUrl>ContentSearchResults</@ofbizUrl>" style="margin: 0;">
      ...
      <table cellspacing="0" class="am-table am-table-striped am-table-hover table-main">
        <tr>
        ...
        <input type="image" src="<@ofbizContentUrl>/images/spacer.gif</@ofbizContentUrl>" onclick="document.advToKeyWordSearchForm.submit();"/>
    </form>
  </div>
</div>
