            ...
            if (featureSet) {
                ...
                if (variantTree && imageMap) {
                    ...
                    if (variants) {
                        ...
                        // Create the javascript to return the listPrice for each variant  Add By Changsy
                        listPriceJS = new StringBuffer()
                        listPriceJS.append("function getListPrice(sku) { ")
                        // Create the javascript to return the promotion for each variant  Add By Changsy
