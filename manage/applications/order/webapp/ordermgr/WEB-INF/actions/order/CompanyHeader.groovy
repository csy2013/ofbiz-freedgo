...
if (partyGroup) {
    ...
    if (partyContent) {
        content = PartyContent.getRelateOne("Content")
        logoImageUrl = org.ofbiz.content.data.OfbizUrlContentWrapper.getOfbizUrlContentAsText(content, locale, dispatcher)
