        ...
        <#if product.isVirtual?exists && product.isVirtual?upper_case == "Y">
          <#if variantTree?exists && 0 < variantTree.size()>
            <#list featureSet as currentType>
              <div>
                <select name="FT${currentType}" onchange="getList(this.name, (this.selectedIndex-1), 1);">
            ...
            <#else>
              <#if question.isSingleChoice()>
                ...
                <#if !question.isMandatory()>
                  <div><input type="radio" name='${counter}' value='<#if !question.isSelected()>checked="checked"</#if>' /> ${uiLabelMap.CommonNoOptions}</div>
                </#if>
                ...
                <#list options as option>
                  ...
                  <#if option.isSelected()>
                    ...
                    <#if option.hasVirtualComponent()>
                      <div >
                        <input type='radio' name='${counter}' id="${counter}_${optionCounter}" value='${optionCounter}' onclick="checkOptionVariants('${counter}_${optionCounter}');" />
              ...
              <#else>
                ...
                <#list options as option>
                    ...
                    <#if option.hasVirtualComponent()>
                      <div >
                        <input type='CHECKBOX' name='${counter}' id="${counter}_${optionCounter}" value='${optionCounter}' onclick="checkOptionVariants('${counter}_${optionCounter}');" />
                        ${option.description} <#if !option.isAvailable()> (*)</#if>
                        <#assign components = option.getComponents()>
                        <#list components as component>
                          <#if (option.isVirtualComponent(component))>
