...
<div class="am-cf am-padding-xs">
	<div id="screenlet_1" class="am-panel am-panel-default">
		<div class="am-panel-hd am-cf">
			${uiLabelMap.OrderOrderReceivedOn} ${Static["org.ofbiz.base.util.UtilDateTime"].toDateString(filterDate)}
			<#assign listSize = state.getSize()>
	      	<#if (listSize > 10)>
	        	<a href="/ordermgr/control/orderlist?viewIndex=${state.getViewIndex() + 1}&amp;viewSize=${state.getViewSize()}&amp;filterDate=${filterDate?if_exists}">${uiLabelMap.CommonMore}</a>
	      	</#if>
