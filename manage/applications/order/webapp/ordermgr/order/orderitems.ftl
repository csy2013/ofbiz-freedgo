...
<@htmlScreenTemplate.renderScreenletBegin id="orderitems" title="&nbsp;${uiLabelMap.OrderOrderItems}" style="panel-default"/>
    ...
    <table class="table table-striped">
            <#--<table class="order-items basic-table" cellspacing='0'>-->
                <tr valign="bottom" class="header-row">
                    ...
                    <th align="right">${uiLabelMap.OrderUnitList}</th>
                    <th align="right">${uiLabelMap.OrderAdjustments}</th>
                    <th align="right">${uiLabelMap.OrderSubTotal}</th>
                    <th>&nbsp;</th>
                </tr>
                ...
                <#else>
                    ...
                    <#list orderItemList as orderItem>
                        ...
                        <tr<#if itemClass == "1"> class="info"</#if> class="info">
                            <#assign orderItemType = orderItem.getRelatedOne("OrderItemType")?if_exists>
                            <#assign productId = orderItem.productId?if_exists>
                            <#if productId?exists && productId == "shoppingcart.CommentLine">
                                <td colspan="7" valign="top" class="info" > &gt;&gt; ${orderItem.itemDescription}</td>
                            <#else>
                                    ...
                                    <div class="screenlet order-item-status-list<#if currentItemStatus.statusCode?has_content> ${currentItemStatus.statusCode}</#if>">
                                        <div class="screenlet-body">
                                            <div class="current-status">
                                                <span>${uiLabelMap.CommonCurrent}</span>&nbsp;${currentItemStatus.get("description")?default(currentItemStatus.statusId)}
                                            </div>
                        ...
                        <#if workOrderItemFulfillments?has_content>
                            <#list workOrderItemFulfillments as workOrderItemFulfillment>
                                ...
                                <tr<#if itemClass == "1"> class="info"</#if>>
                                    <td>&nbsp;</td>
                                    <td colspan="6">
                                    ...
                                    <td align="right" colspan="2">
                                        <#if shipmentReceipt.shipmentId?has_content>
                                            ...
                                            <a target="facility"
                                               ...
                                               class="btn btn-primary btn-xs">${shipmentReceipt.shipmentId}</a>:${shipmentReceipt.shipmentItemSeqId?if_exists}
                                        </#if>
                                        ...
                                        <a href="/facility/control/EditInventoryItem?inventoryItemId=${shipmentReceipt.inventoryItemId}&amp;externalLoginKey=${externalLoginKey}"
                                           class="btn btn-primary btn-xs">${shipmentReceipt.inventoryItemId}</a>
                                    </td>
                                    <td align="center">
