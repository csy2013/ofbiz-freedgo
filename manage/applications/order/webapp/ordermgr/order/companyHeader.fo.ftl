...
<fo:block text-align="left">
    <#if logoImageUrl?has_content><fo:external-graphic src="http://changsy.cn/${logoImageUrl}" overflow="hidden" height="40px" content-height="scale-to-fit" content-width="2.00in"/></#if>
</fo:block>
