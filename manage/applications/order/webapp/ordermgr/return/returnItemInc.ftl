...
<table cellspacing="0" class="basic-table">
    <tr>
      ...
      <td colspan="2" align="right">
        ...
        <input type="checkbox" name="selectAll" value="Y" onclick="toggleAll(this, '${selectAllFormName}');highlightAllRows(this, 'returnItemId_tableRow_', 'selectAllForm');"/>
      </td>
    </tr>
      ...
      <#list returnableItems.keySet() as orderItem>
        <#if orderItem.getEntityName() == "OrderAdjustment">
            ...
            <input type="hidden" name="orderAdjustmentId_o_${rowCount}" value="${orderItem.orderAdjustmentId}"/>
              ...
              <td></td>
              <td align="right">
                <input type="checkbox" name="_rowSubmit_o_${rowCount}" value="Y" onclick="checkToggle(this, '${selectAllFormName}');highlightRow(this,'returnItemId_tableRow_${rowCount}');"/>
              </td>
            </tr>
        <#else>
    ...
    <#if orderHeaderAdjustments?has_content>
      ...
      <#list orderHeaderAdjustments as adj>
        ...
        <input type="hidden" name="description_o_${rowCount}" value="${description}"/>
          ...
          <td align="right">
            <input type="checkbox" name="_rowSubmit_o_${rowCount}" value="Y" onclick="checkToggle(this, '${selectAllFormName}');"/>
          </td>
        </tr>
        <#assign rowCount = rowCount + 1>
      </#list>
