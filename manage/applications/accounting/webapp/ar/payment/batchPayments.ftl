        ...
        <form id="paymentBatchForm" method="post" action="">
            <#if paymentList?has_content>
                ...
                <div class="align-float">
                    ...
                    <input id="submitButton" type="button" onclick="jQuery('#paymentBatchForm').submit();" value="${uiLabelMap.CommonRun}" disabled="disabled" />
                  ...
                  <thead>
                    <tr class="header-row-2">
                      ...
                      <th>
                        ...
                        <input type="checkbox" id="checkAllPayments" name="checkAllPayments" onchange="togglePaymentId(this);"/>
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <#list paymentList as payment>
                      <tr <#if alt_row> class="alternate-row"</#if>>
                        ...
                        <td>
                          <input type="checkbox" id="paymentId_${payment_index}" name="paymentIds" value="${payment.paymentId}" onclick="getPaymentRunningTotal('paymentId_${payment_index}');" />
                        </td>
                      </tr>
