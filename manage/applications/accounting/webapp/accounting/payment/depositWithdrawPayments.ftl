            ...
            <#if paymentList?has_content>
                ...
                <table class="basic-table">
                    <tr class="header-row-2">
                        ...
                        <td align="right">${uiLabelMap.CommonSelectAll}<input type="checkbox" id="checkAllPayments" name="checkAllPayments" onchange="togglePaymentId(this);"/></td>
                    </tr>
                    ...
                    <#list paymentList as payment>
                        <tr <#if alt_row> class="alternate-row"</#if>>
                            ...
                            <td align="right">${uiLabelMap.AccountingDeposit}<input type="checkbox" id="paymentId_${payment_index}" name="paymentIds" value="${payment.paymentId}" onclick="getPaymentRunningTotal();"/></td>
                        </tr>
                    ...
                    <div align="right">
                        ...
                        <input id="submitButton" type="button"  onclick="document.depositWithdrawPaymentsForm.submit();" value="${uiLabelMap.AccountingDepositWithdraw}" disabled="disabled"/>
                    </div>
                </table>
            <#else>
