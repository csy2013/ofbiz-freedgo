            ...
            <form name="routeForm" method="post" action="<@ofbizUrl>setQuickRouteInfo</@ofbizUrl>">
              ...
              <table border="0" cellpadding="2" cellspacing="0">
                ...
                <tr>
                  ...
                  <td>&nbsp;</td>
                  <td width="80%">
                    <input type="image" src="<@ofbizContentUrl>/images/spacer.gif</@ofbizContentUrl>" onclick="document.routeForm.submit();" />
                  </td>
                </tr>
              </table>
            </form>
          ...
          <form name="weightForm" method="post" action="<@ofbizUrl>setQuickPackageWeight</@ofbizUrl>">
            ...
            <table cellspacing="0" class="basic-table">
              ...
              <tr>
                <td colspan="2">&nbsp;</td>
                <td width="80%">
                  <input type="image" src="<@ofbizContentUrl>/images/spacer.gif</@ofbizContentUrl>" onclick="document.weightForm.submit();"/>
