                    ...
                    <tr class="header-row">
                        ...
                        <#if itemsAvailableToReceive>
                            ...
                            <td colspan="2" align="right">
                                <div>${uiLabelMap.CommonAll}<input type="checkbox" name="selectAll" value="${uiLabelMap.CommonY}" onclick="toggleAll(this, 'selectAllForm');highlightAllRows(this, 'orderItemData_tableRow_', 'selectAllForm');" /></div>
                            </td>
                        </#if>
                    </tr>
                    ...
                    <#list orderItemDatas?if_exists as orderItemData>
                        ...
                        <tr id="orderItemData_tableRow_${rowCount}" valign="middle"<#if alt_row> class="alternate-row"</#if>>
                            ...
                            <#if availableToReceive &gt; 0 >
                                ...
                                <td align="right">
                                  <input type="checkbox" name="_rowSubmit_o_${rowCount}" value="Y" onclick="checkToggle(this, 'selectAllForm');highlightRow(this,'orderItemData_tableRow_${rowCount}');" />
                                </td>
