          ...
          <tr>
            ...
            <td>
              ...
              <#if security.hasEntityPermission("FACILITY", "_UPDATE", session)>
                  <@htmlScreenTemplate.renderModalPage id="EditContactMechForPhone_${contactMech.contactMechId}"  name="EditContactMechForPhone_${contactMech.contactMechId}" buttonType="button" modalUrl="/facility/control/EditContactMech" modalMsg="" modalTitle="修改"
                  description="${uiLabelMap.CommonUpdate}" targetParameterIter="facilityId:'${facilityId}',contactMechId:contactMechId='${contactMech.contactMechId}'">
                  </@htmlScreenTemplate.renderModalPage>
                <#--<a href='<@ofbizUrl>EditContactMech?facilityId=${facilityId}&amp;contactMechId=${contactMech.contactMechId}</@ofbizUrl>' class="btn btn-primary btn-sm">${uiLabelMap.CommonUpdate}</a>-->
              </#if>
                <br/><br/>
