<#escape x as x?xml>
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" font-family="Arial,simhei">
                            ...
                            <fo:table-body>
                                <fo:table-row>
                                    <fo:table-cell>
                                        ...
                                        <fo:block> ${orderId} (${shipGroupSeqId})</fo:block>
                                        <fo:block font-weight="bold">${uiLabelMap.OrderOrderDate}:</fo:block>
                                        <fo:block> ${orderDate?string("yyyy-MM-dd HH:mm:ss")}</fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                                        <fo:table>
                                            <fo:table-column column-width="200pt"/>
                                            ...
                                            <fo:table-body>
                                                <fo:table-row>
                                                    <fo:table-cell>
                                                        ...
                                                        <fo:block> ${Static["org.ofbiz.common.geo.GeoWorker"].getGeoNameById(shipAddress.stateProvinceGeoId?if_exists,delegator)}
                                                               ${Static["org.ofbiz.common.geo.GeoWorker"].getGeoNameById(shipAddress.city?if_exists,delegator)}
                                                              ${Static["org.ofbiz.common.geo.GeoWorker"].getGeoNameById(shipAddress.address1?if_exists,delegator)}</fo:block>
                                                        <fo:block>(${shipAddress.toName?if_exists})收</fo:block>
                ...
                <fo:block space-after.optimum="10pt" font-size="12pt">
                    <fo:table border-width="1pt" border-style="solid">
                        ...
                        <fo:table-body>
                            <fo:table-row>
                                <fo:table-cell>
                                    <fo:block>${uiLabelMap.ProductLocation}</fo:block>
                                </fo:table-cell>
                                <fo:table-cell>
                                    <fo:block>${uiLabelMap.ProductItemId}</fo:block>
                                </fo:table-cell>
                                <fo:table-cell>
                                    <fo:block>${uiLabelMap.ProductProductName}</fo:block>
                                </fo:table-cell>
                                <fo:table-cell>
                                    <fo:block>${uiLabelMap.FormFieldTitle_supplierProductId}</fo:block>
                                </fo:table-cell>
                                <fo:table-cell>
                                    <fo:block>${uiLabelMap.OrderQty}</fo:block>
                                </fo:table-cell>
                                <fo:table-cell>
                                    <fo:block>${uiLabelMap.OrderUnitPrice}</fo:block>
                                </fo:table-cell>
                            </fo:table-row>
                            <#assign totalQty = 0>
                                        ...
                                        <#if (quantityToPick > 0)>
                                            <fo:table-row background-color="${rowColor}">
                                                <#if infoItem.facilityLocation?has_content>
                                                    ...
                                                    <fo:table-cell>
                                                        <fo:block font-size="10pt">${facilityLocation.locationSeqId?default("_NA_")}</fo:block>
                                                    </fo:table-cell>
                                                <#else>
                                                    <fo:table-cell>
                                                        <fo:block font-size="10pt">_NA_</fo:block>
                                                    </fo:table-cell>
                                                </#if>
                                                <fo:table-cell>
                                                    <fo:block font-size="10pt">${product.productId}</fo:block>
                                                </fo:table-cell>
                                                <fo:table-cell>
                                                    <fo:block font-size="10pt">${product.internalName?if_exists}</fo:block>
                                                </fo:table-cell>
                                                <#if supplierProduct?has_content >
                                                    <fo:table-cell>
                                                        <fo:block font-size="10pt">${supplierProduct.supplierProductId?if_exists}</fo:block>
                                                    </fo:table-cell>
                                                <#else>
                                                    <fo:table-cell>
                                                ...
                                                <fo:table-cell>
                                                    <fo:block font-size="10pt">${quantityToPick?if_exists}</fo:block>
                                                </fo:table-cell>
                                                <fo:table-cell>
                                                    <fo:block font-size="10pt"><@ofbizCurrency amount=orderItem.unitPrice isoCode=currencyUomId/></fo:block>
                                                </fo:table-cell>
                                            </fo:table-row>
                                        </#if>
                                                            ...
                                                            <#if workEffortInventoryAssigns?has_content>
                                                                <#list workEffortInventoryAssigns as workEffortInventoryAssign>
                                                                    ...
                                                                    <#-- bin location -->
                                                                        <fo:table-cell>
                                                                            <fo:block
                                                                                    font-size="10pt"><#if inventoryItem?exists>${inventoryItem.locationSeqId?default("_NA_")}</#if></fo:block>
                                                                        </fo:table-cell>
                                                                    ...
                                                                    <#-- product ID -->
                                                                        ...
                                                                        <#else>
                                                                            <fo:table-cell>
                                                                                <fo:block font-size="10pt">[N/A]</fo:block>
                                                                            </fo:table-cell>
                                                                        </#if>
                                                                    ...
                                                                    <#-- product name -->
                                                                        <#if product?has_content>
                                                                            <fo:table-cell>
                                                                                <fo:block
                                                                                        font-size="10pt">${product.productName?default(product.internalName?default("[Not Internal Name Set!]"))?xml}</fo:block>
                                                                            </fo:table-cell>
                                                                        <#else>
                                                                            <fo:table-cell>
                                                                                <fo:block font-size="10pt">[N/A]</fo:block>
                                                                    ...
                                                                    <#-- supplier -->
                                                                        <#if vendor?has_content >
                                                                            <fo:table-cell>
                                                                                <fo:block font-size="10pt">${vendor.supplierProductId?if_exists}</fo:block>
                                                                            </fo:table-cell>
                                                                        <#else>
                                                                            <fo:table-cell>
                                                                                <fo:block font-size="10pt"></fo:block>
                                                                    ...
                                                                    <#-- quantity -->
                                                                        <fo:table-cell>
                                                                            <fo:block font-size="10pt">${workEffortInventoryAssign.quantity?if_exists}</fo:block>
                                                                        </fo:table-cell>
                        ...
                        <fo:table-body>
                            <#list orderHeaderAdjustments as orderHeaderAdjustment>
                                ...
                                <#if adjustmentAmount != 0>
                                    <fo:table-row>
                                        <fo:table-cell>
                                            <fo:block>${adjustmentType.get("description",locale)}:</fo:block>
                                        </fo:table-cell>
                                        <fo:table-cell>
                            ...
                            <#list orderChargeList as orderCharge>
                                <#if orderCharge.get("${orderId}")?exists >
                                    ...
                                    <fo:table-row>
                                        ...
                                        <fo:table-cell>
                                            <fo:block><@ofbizCurrency amount=charges.orderSubTotal isoCode=currencyUomId/></fo:block>
                                        </fo:table-cell>
                                    </fo:table-row>
                                    <fo:table-row>
                                        <fo:table-cell>
                                        ...
                                        <fo:table-cell>
                                            <fo:block><@ofbizCurrency amount=charges.taxAmount isoCode=currencyUomId/></fo:block>
                                        </fo:table-cell>
                                    </fo:table-row>
                                    <fo:table-row>
                                        <fo:table-cell>
                                            <fo:block>${uiLabelMap.OrderTotalShippingAndHandling}:</fo:block>
                                        </fo:table-cell>
                                        <fo:table-cell>
                                            <fo:block><@ofbizCurrency amount=charges.shippingAmount isoCode=currencyUomId/></fo:block>
                                        </fo:table-cell>
                                    </fo:table-row>
                                    <fo:table-row>
                                        <fo:table-cell>
                                            <fo:block>${uiLabelMap.OrderTotalOtherOrderAdjustments}:</fo:block>
                                        </fo:table-cell>
                                        <fo:table-cell>
                                            <fo:block><@ofbizCurrency amount=charges.otherAdjAmount isoCode=currencyUomId/></fo:block>
                                        </fo:table-cell>
                                    </fo:table-row>
                                    <fo:table-row>
                                        <fo:table-cell>
                                            <fo:block>${uiLabelMap.OrderGrandTotal}:</fo:block>
                                        </fo:table-cell>
                                        <fo:table-cell>
                                            <fo:block><@ofbizCurrency amount=charges.grandTotal isoCode=currencyUomId/></fo:block>
                                        </fo:table-cell>
                                    </fo:table-row>
                                    <fo:table-row>
                                        <fo:table-cell>
                                            <fo:block text-align="left"> ${uiLabelMap.OrderPickedBy}: ______________</fo:block>
                                        </fo:table-cell>
                                    </fo:table-row>
                                    <#--<fo:table-row>
                                        <fo:table-cell>
                                            <fo:block text-align="center"> ${uiLabelMap.OrderTotalNoOfItems}: ${totalQty}</fo:block>
                                        </fo:table-cell>
                                    </fo:table-row>-->
                                </#if>
                            </#list>
