            ...
            <#--<#if mechMap.facilityContactMechPurposes?has_content>
                ...
                <#list mechMap.facilityContactMechPurposes as facilityContactMechPurpose>
                        ...
                        <div class="col-md-5">
                                ...
                                <a href="javascript:document.getElementById('deleteFacilityContactMechPurpose_${facilityContactMechPurpose_index}').submit();"
                ...
                &lt;#&ndash; toggle the row color &ndash;&gt;
                    ...
                    <form id="deleteFacilityContactMechPurpose_${facilityContactMechPurpose_index}" method="post"
                          action="<@ofbizUrl>deleteFacilityContactMechPurpose</@ofbizUrl>" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    ...
                    <input class="form-control" type="text" size="6" maxlength="10" name="extension"
                                         value="${(mechMap.facilityContactMech.extension)?default(request.getParameter('extension')?if_exists)}"/>
                </div>
            </div>
