...
<form action="<@ofbizUrl>createProductPromoAction</@ofbizUrl>" class="form-horizontal" method="post">
    <input type="hidden" name="productPromoId" value="${productPromoId}"/>
    <input type="hidden" name="productPromoRuleId" value="${productPromoRuleId}"/>
    <input type="hidden" name="productPromoCondSeqId" value="${productPromoCondSeqId}"/>
    ...
    <div class="form-group">
        <label class="col-md-5 control-label">${uiLabelMap.ProductAmount}:</label>
        <div class="col-md-7">
    ...
    <#--<div class="form-group">
        ...
        <div class="col-md-7">
            <input type="text" size="15" name="productId" class="form-control"/>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-7">
            <input type="text" size="10" class="form-control" name="partyId"/>
        </div>
    </div>-->
    <#--<div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-md-7">
            <input type="submit" value="${uiLabelMap.ProductCreateActionition}"/>
        </div>
    </div>
</form>
