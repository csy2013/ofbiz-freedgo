        ...
        <div class="am-panel-bd am-collapse am-in" id="screenlet_1_col">
            <div class="am-g">
                <div class="am-u-sm-12">
                    <form name="advtokeywordsearchform" method="post" action="<@ofbizUrl>keywordsearch</@ofbizUrl>"  class="am-form am-form-inline">
                        <input type="hidden" name="VIEW_SIZE" value="25"/>
                        <input type="hidden" name="PAGING" value="Y"/>
                        <input type="hidden" name="noConditionFind" value="Y"/>
                    <#if searchCategory?has_content>
                        ...
                        <#else>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="am-g">
                                        <div class="am-u-lg-4">
                                        <@amazeHtmlTemplate.lookupField value="${requestParameters.SEARCH_CATEGORY_ID?if_exists}" formName="advtokeywordsearchform" name="SEARCH_CATEGORY_ID" id="SEARCH_CATEGORY_ID" fieldFormName="LookupProductCategory"/>
                                        </div>
                          ...
                          <#assign productFeatures = productFeaturesByTypeMap[productFeatureTypeId]>
                            ...
                            <tr>
                                ...
                                <td valign="middle">
                                    <div class="am-g">
                                        <div class="am-u-lg-4">
                                        <@amazeHtmlTemplate.lookupField value="${requestParameters.PRIORITIZE_CATEGORY_ID?if_exists}" formName="advtokeywordsearchform" name="PRIORITIZE_CATEGORY_ID" id="PRIORITIZE_CATEGORY_ID" fieldFormName="LookupProductCategory"/>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                        ...
                        <#if searchConstraintStrings?has_content>
                            ...
                            <tr>
                                <td align="center" colspan="2">
                                    <hr />
                                    <input type="submit" value="${uiLabelMap.CommonFind}" class="am-btn am-btn-primary am-btn-sm"/>
                                </td>
                            </tr>
                        </table>
                    </form>
