...
<%@ page import="org.ofbiz.base.util.Debug, org.ofbiz.base.util.UtilFormatOut, org.ofbiz.base.util.UtilMisc" %>
<%@ page import="org.ofbiz.base.util.UtilValidate" %>
<%@ page import="org.ofbiz.entity.GenericValue, org.ofbiz.entity.condition.EntityComparisonOperator, org.ofbiz.entity.condition.EntityCondition, org.ofbiz.entity.condition.EntityExpr" %>
<%@ page import="org.ofbiz.entity.condition.EntityJoinOperator, org.ofbiz.entity.model.ModelEntity, org.ofbiz.entity.model.ModelReader, org.ofbiz.entity.model.ModelViewEntity" %>
<%@ page import="org.ofbiz.entity.transaction.TransactionUtil" %>
<%@ page import="org.ofbiz.entity.util.EntityFindOptions" %>
<%@ page import="org.ofbiz.entity.util.EntityListIterator" %>
<%@ page import="java.io.*" %>
...
//    passedEntityNames.add("ProdCatalogRole");
  ...
  boolean tobrowser = request.getParameter("tobrowser") != null;
