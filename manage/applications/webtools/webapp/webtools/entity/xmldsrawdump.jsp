...
under the License.
--%><%@ page import="org.ofbiz.base.util.Debug, org.ofbiz.base.util.UtilJ2eeCompat, org.ofbiz.entity.GenericEntityException, org.ofbiz.entity.GenericValue, org.ofbiz.entity.condition.EntityExpr, org.ofbiz.entity.model.ModelEntity, org.ofbiz.entity.model.ModelReader, org.ofbiz.entity.transaction.TransactionUtil, org.ofbiz.entity.util.EntityListIterator, java.io.PrintWriter, java.util.Collection" %>
<%@ page import="java.util.Iterator" %>
<%@ page import="java.util.TreeSet" %>
<%@ taglib uri="ofbizTags" prefix="ofbiz" %><jsp:useBean id="security" type="org.ofbiz.security.Security" scope="request" /><jsp:useBean id="delegator" type="org.ofbiz.entity.GenericDelegator" scope="request" /><%
