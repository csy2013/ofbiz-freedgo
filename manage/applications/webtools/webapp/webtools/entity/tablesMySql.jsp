...
if(security.hasPermission("ENTITY_MAINT", session)) {
  ...
  while(classNamesIterator != null && classNamesIterator.hasNext()) { ModelEntity entity = reader.getModelEntity(classNamesIterator.next());%>
