            ...
            <tr>
                <td colspan="2" align="center">
                    ...
                    <#if parameters.sourceKey?exists>
                        ...
                        <input type="submit" value="${uiLabelMap.CommonUpdate}" name="confirm" onclick="updateAndSaveLabel()"/>
                    <#else>
                        <input type="submit" value="${uiLabelMap.CommonAdd}" name="confirm"/>
                        <input type="submit" value="${uiLabelMap.WebtoolsLabelManagerUpdateAndSave}" name="confirm" onclick="updateAndSaveLabel()"/>
                    </#if>
                </td>
            </tr>
