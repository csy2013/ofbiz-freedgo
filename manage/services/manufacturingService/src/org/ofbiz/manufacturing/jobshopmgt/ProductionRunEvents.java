    ...
    public static String productionRunDeclareAndProduce(HttpServletRequest request, HttpServletResponse response) {
        ...
        for (Map<String, Object>componentRow : componentRows) {
            ...
            GenericPK key = delegator.makePK("WorkEffortGoodStandard", 
                    UtilMisc.<String, Object>toMap("workEffortId", componentRow.get("productionRunTaskId"),
                            "productId", componentRow.get("productId"),
                            "fromDate", fromDate,
                            "workEffortGoodStdTypeId", "PRUNT_PROD_NEEDED"));
            componentsLocationMap.put(key, 
                    UtilMisc.<String, Object>toMap("locationSeqId", componentRow.get("locationSeqId"),
                            "secondaryLocationSeqId", componentRow.get("secondaryLocationSeqId"),
                            "failIfItemsAreNotAvailable", componentRow.get("failIfItemsAreNotAvailable")));
        }
