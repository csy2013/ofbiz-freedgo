...
public class ShoppingCartItem implements java.io.Serializable {
    ...
    */
    public static ShoppingCartItem makeItem(Integer cartLocation, GenericValue product, BigDecimal selectedAmount,
        ...
        boolean triggerPriceRules = triggerPriceRulesBool == null || triggerPriceRulesBool.booleanValue();
        boolean triggerExternalOps = triggerExternalOpsBool == null || triggerExternalOpsBool.booleanValue();
...
//   满足条件，我们始终认为可用促销数据为1         return this.quantity.subtract(this.promoQuantityUsed);
...
//            return new BigDecimal(1);
     ...
     * @param productPromoCondAction
     * @param checkAvailableOnly
     * @return
     */
    ...
    public boolean isInItemGroup(String groupNumber) {
        ...
        return this.itemGroup.getGroupNumber().equals(groupNumber);
    }
