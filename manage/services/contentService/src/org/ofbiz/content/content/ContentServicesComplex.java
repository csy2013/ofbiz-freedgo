    ...
    */
    ...
    public static Map<String, Object> getAssocAndContentAndDataResourceCacheMethod(Delegator delegator, String contentId, String mapKey, String direction,
        ...
        for(GenericValue contentAssoc : contentAssocsTypeFiltered) {
            ...
            SimpleMapProcessor.runSimpleMapProcessor("component://contentService/script/org/ofbiz/content/ContentManagementMapProcessors.xml", "contentAssocOut", contentAssoc, contentAssocDataResourceView, FastList.newInstance(), locale);
            ...
            if (dataResource != null) {
                ...
                SimpleMapProcessor.runSimpleMapProcessor("component://contentService/script/org/ofbiz/content/ContentManagementMapProcessors.xml", "dataResourceOut", dataResource, contentAssocDataResourceView, FastList.newInstance(), locale);
            }
            //if (Debug.infoOn()) Debug.logInfo("contentAssocDataResourceView:" + contentAssocDataResourceView, module);
