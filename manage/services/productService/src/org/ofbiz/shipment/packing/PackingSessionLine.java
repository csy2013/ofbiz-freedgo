...
public class PackingSessionLine implements java.io.Serializable {
    ...
    public final String module = org.ofbiz.shipment.packing.PackingSessionLine.class.getName();
    ...
    public boolean isSameItem(org.ofbiz.shipment.packing.PackingSessionLine line) {
