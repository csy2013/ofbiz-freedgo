...
public class ProductPromoContentWrapper implements ContentWrapper {
    ...
    public static final String module = org.ofbiz.product.product.ProductPromoContentWrapper.class.getName();
    ...
    public static org.ofbiz.product.product.ProductPromoContentWrapper makeProductPromoContentWrapper(GenericValue productPromo, HttpServletRequest request) {
        return new org.ofbiz.product.product.ProductPromoContentWrapper(productPromo, request);
    }
