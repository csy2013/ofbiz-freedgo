...
public class ProductSearchEvents {
    ...
    public static final String module = org.ofbiz.product.product.ProductSearchEvents.class.getName();
   ...
   public static String searchAddToCategory(HttpServletRequest request, HttpServletResponse response) {
    ...
    public static EntityListIterator getProductSearchResults(HttpServletRequest request) {
        ...
        List<org.ofbiz.product.product.ProductSearch.ProductSearchConstraint> productSearchConstraintList = org.ofbiz.product.product.ProductSearchSession.ProductSearchOptions.getConstraintList(session);
        // if no constraints, don't do a search...
        if (UtilValidate.isNotEmpty(productSearchConstraintList)) {
            ResultSortOrder resultSortOrder = org.ofbiz.product.product.ProductSearchSession.ProductSearchOptions.getResultSortOrder(request);
            org.ofbiz.product.product.ProductSearchSession.checkSaveSearchOptionsHistory(session);
