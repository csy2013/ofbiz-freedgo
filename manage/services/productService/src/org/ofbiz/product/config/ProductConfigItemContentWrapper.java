...
public class ProductConfigItemContentWrapper implements java.io.Serializable {
    ...
    public static final String module = org.ofbiz.product.config.ProductConfigItemContentWrapper.class.getName();
    ...
    public static org.ofbiz.product.config.ProductConfigItemContentWrapper makeProductConfigItemContentWrapper(GenericValue productConfigItem, HttpServletRequest request) {
        return new org.ofbiz.product.config.ProductConfigItemContentWrapper(productConfigItem, request);
    }
