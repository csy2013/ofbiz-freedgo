...
public class CatalogUrlFilter extends ContextFilter {
    ...
    public final static String module = org.ofbiz.product.category.CatalogUrlFilter.class.getName();
    ...
    public static String makeCategoryUrl(HttpServletRequest request, String previousCategoryId, String productCategoryId, String productId, String viewSize, String viewIndex, String viewSort, String searchString) {
        ...
        try {
            ...
            org.ofbiz.product.category.CategoryContentWrapper wrapper = new org.ofbiz.product.category.CategoryContentWrapper(productCategory, request);
    ...
    public static String makeCategoryUrl(Delegator delegator, org.ofbiz.product.category.CategoryContentWrapper wrapper, List<String> trail, String contextPath, String previousCategoryId, String productCategoryId, String productId, String viewSize, String viewIndex, String viewSort, String searchString) {
        String url = "";
