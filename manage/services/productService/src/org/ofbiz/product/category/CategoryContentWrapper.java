...
public class CategoryContentWrapper implements ContentWrapper {
    ...
    public static final String module = org.ofbiz.product.category.CategoryContentWrapper.class.getName();
    ...
    public static org.ofbiz.product.category.CategoryContentWrapper makeCategoryContentWrapper(GenericValue productCategory, HttpServletRequest request) {
        return new org.ofbiz.product.category.CategoryContentWrapper(productCategory, request);
    }
