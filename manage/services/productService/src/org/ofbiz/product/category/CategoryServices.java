...
public class CategoryServices {
  ...
  public static Map<String, Object> getSpecialProducts(DispatchContext dcx, Map<String, ? extends Object> context) {
    ...
    if (dataGetType.equals("first")) {
      limitView1 = true;
      defaultViewSize1 = 1;
    }
    if (dataGetType.equals("appoint") || dataGetType.equals("random")) {
      limitView1 = false;
      defaultViewSize1 = 50;
      //最多50个
    }
    ...
    if (resultProdCateMembers != null) result.put("productCategoryMembers", resultProdCateMembers);
    return result;
  }
