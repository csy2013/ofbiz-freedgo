                ...
                if (row != null) {
                    ...
                    if (productId != null && !productId.trim().equalsIgnoreCase("") && !productExists) {
                        ...
                        if (quantityOnHand.compareTo(BigDecimal.ZERO) >= 0)
                            inventoryItems.add(org.ofbiz.product.spreadsheetimport.ImportProductHelper.prepareInventoryItem(productId, quantityOnHand,
                                    delegator.getNextSeqId("InventoryItem")));
                        else
                            inventoryItems.add(org.ofbiz.product.spreadsheetimport.ImportProductHelper.prepareInventoryItem(productId, BigDecimal.ZERO, delegator
