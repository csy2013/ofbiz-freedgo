...
public class SecurePayServiceTest extends OFBizTestCase{
    ...
    public void testAuth() throws Exception{
        ...
        try {
            ...
            if (result.get("authResult").equals(new Boolean(false))) {          // returnCode ok?
    ...
    public void testdoCapture() throws Exception {
        ...
        try {
            ...
            if (result.get("captureResult").equals(new Boolean(false))) {          // returnCode ok?
    ...
    public void testdoRefund() throws Exception {
        ...
        try {
            ...
            if (result.get("refundResult").equals(new Boolean(false))) {          // returnCode ok?
    ...
    public void testdoCredit() throws Exception{
        ...
        try {
            ...
            if (result.get("creditResult").equals(new Boolean(false))) {          // returnCode ok?
