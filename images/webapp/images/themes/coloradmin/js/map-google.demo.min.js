...
var handleGoogleMapSetting = function () {
    ...
    var s = [{stylers: [{hue: "#2c3e50"}, {saturation: 250}]}, {
        featureType: "road",
        elementType: "geometry",
    ...
    var a = [{
        featureType: "all",
        elementType: "all",
        stylers: [{invert_lightness: true}, {saturation: 10}, {lightness: 10}, {gamma: .8}, {hue: "#000000"}]
    }, {featureType: "water", stylers: [{visibility: "on"}, {color: "#293036"}]}];
    $("[data-map-theme]").click(function () {
        ...
        switch (t) {
            ...
            case"icy-blue":
                ...
                break;
            case"cobalt":
                e.setOptions({styles: u});
                c = true;
                break;
            case"old-dry-mud":
                e.setOptions({styles: o});
                break;
            case"dark-red":
