...
jQuery.fn.rater	= function(options) {
	...
	var settings = {
		...
		title_format	: null,
		info_format	: null,
		image	: '/images/wap/images/stars.jpg',
		imageAll :'/images/wap/images/stars-all.gif',
		defaultTips :true,
		clickTips :true,
		width	: 24,
		height	: 24
	...
	content.find('.rater-star-item')/*.mouseover(function() {
		...
		if(current_value==1){
			$("#" + formId + " #one").attr("checked","true");
		}else if(current_value==2){
			$("#" + formId + " #two").attr("checked","true");
		}else if(current_value==3){
			$("#" + formId + " #three").attr("checked","true");
		}else if(current_value==4){
			$("#" + formId + " #four").attr("checked","true");
		}else if(current_value==5){
			$("#" + formId + " #five").attr("checked","true");
		}
