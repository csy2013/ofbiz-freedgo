	 /*
      * Jquery鈥攕hopping   0.1
      * Copyright (c) 2013  Nicky Yan   涓汉缃戯細绔檋ttp://www.chinacoder.cn  QQ锛�525690001
      * Date: 2013-04-02
      * 浣跨敤Jquery鈥攕hopping鍙互寰堟柟渚跨殑瀹炵幇鍔犲叆璐墿杞︽晥鏋�
	 */
				...
				addShoping:function(e){
					...
					if(dis){
						if ($('#floatOrder').length <= 0) {
							$('body').append('<div id="floatOrder"><img src="images/product/wine/wine1.jpg" width="50" height="50" /></div');
						};
						var $obj=$('#floatOrder');
						if(!$obj.is(':animated')){
