...
var ZYFILE = {
	...
	funUploadFile : function(file){
		...
		if($("#partyId").val()!=""){
			...
			formdata.append("partyId","admin");
		}
		formdata.append("dataCategoryId","PERSONAL");
		if($("#contentTypeId").val()!=""){
			formdata.append("contentTypeId",$("#contentTypeId").val());
		}else{
			formdata.append("contentTypeId","PERSON");
		}
		formdata.append("statusId","CTNT_PUBLISHED");
		formdata.append("roleTypeId","OWNER");
		if($("#partyContentTypeId").val()!=""){
			formdata.append("partyContentTypeId",$("#partyContentTypeId").val());
		}else{
			formdata.append("partyContentTypeId","INTERNAL");
		}
		formdata.append("mimeTypeId","");
